...
//#endregion
//#region ../node_modules/@unlayer/exporters/index.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_server_browser = /* @__PURE__ */ __toESM(require_server_browser());
var Jc = Object.create;
...
var Xc = (t, e, r, n) => {
	if (e && typeof e == "object" || typeof e == "function") for (let l of Zc(e)) !Yc.call(t, l) && l !== r && Cr(t, l, {
		get: () => e[l],
		enumerable: !(n = Kc(e, l)) || n.enumerable
	});
	return t;
};
var I = (t, e, r) => (r = t != null ? Jc(Qc(t)) : {}, Xc(e || !t || !t.__esModule ? Cr(r, "default", {
	value: t,
	enumerable: !0
}) : r, t));
var ht = c((Qk, kr) => {
	kr.exports = typeof global == "object" && global && global.Object === Object && global;
});
var F = c((Yk, Sr) => {
	var td = ht(), rd = typeof self == "object" && self && self.Object === Object && self;
	Sr.exports = td || rd || Function("return this")();
});
var M = c((Xk, Ar) => {
	Ar.exports = F().Symbol;
});
var Je = c((eS, Tr) => {
	function ad(t, e) {
		for (var r = -1, n = t == null ? 0 : t.length, l = Array(n); ++r < n;) l[r] = e(t[r], r, t);
		return l;
	}
	Tr.exports = ad;
});
var P = c((tS, qr) => {
	qr.exports = Array.isArray;
});
var Er = c((rS, Hr) => {
	var Ir = M(), Pr = Object.prototype, sd = Pr.hasOwnProperty, ud = Pr.toString, ye = Ir ? Ir.toStringTag : void 0;
	function cd(t) {
		var e = sd.call(t, ye), r = t[ye];
		try {
			t[ye] = void 0;
			var n = !0;
		} catch {}
		var l = ud.call(t);
		return n && (e ? t[ye] = r : delete t[ye]), l;
	}
	Hr.exports = cd;
});
var Fr = c((nS, Wr) => {
...
var N = c((oS, Br) => {
	var Or = M(), md = Er(), gd = Fr(), hd = "[object Null]", bd = "[object Undefined]", Dr = Or ? Or.toStringTag : void 0;
	function _d(t) {
		return t == null ? t === void 0 ? bd : hd : Dr && Dr in Object(t) ? md(t) : gd(t);
	}
	Br.exports = _d;
});
var B = c((iS, $r) => {
...
var xe = c((aS, Lr) => {
	var xd = N(), vd = B(), wd = "[object Symbol]";
	function Cd(t) {
		return typeof t == "symbol" || vd(t) && xd(t) == wd;
	}
	Lr.exports = Cd;
});
var Mr = c((lS, Ur) => {
	var Rr = M(), kd = Je(), Sd = P(), Ad = xe(), Td = Infinity, zr = Rr ? Rr.prototype : void 0, jr = zr ? zr.toString : void 0;
	function Vr(t) {
		if (typeof t == "string") return t;
		if (Sd(t)) return kd(t, Vr) + "";
		if (Ad(t)) return jr ? jr.call(t) : "";
		var e = t + "";
...
var Yr = c((dS, Qr) => {
	var Fd = ve(), Od = Kr(), Zr = /&(?:amp|lt|gt|quot|#39);/g, Dd = RegExp(Zr.source);
	function Bd(t) {
		return t = Fd(t), t && Dd.test(t) ? t.replace(Zr, Od) : t;
	}
	Qr.exports = Bd;
});
var _t = c((pS, Xr) => {
...
var Ke = c((fS, en) => {
	en.exports = _t()(Object.getPrototypeOf, Object);
});
var we = c((mS, rn) => {
	var zd = N(), jd = Ke(), Vd = B(), Ud = "[object Object]", Md = Function.prototype, Nd = Object.prototype, tn = Md.toString, Gd = Nd.hasOwnProperty, Jd = tn.call(Object);
	function Kd(t) {
		if (!Vd(t) || zd(t) != Ud) return !1;
		var e = jd(t);
		if (e === null) return !0;
		var r = Gd.call(e, "constructor") && e.constructor;
		return typeof r == "function" && r instanceof r && tn.call(r) == Jd;
	}
	rn.exports = Kd;
});
var Ce = c((xS, an) => {
	...
	function Yd(t) {
		...
		return t === (typeof e == "function" && e.prototype || Qd);
	}
	an.exports = Yd;
});
var sn = c((vS, ln) => {
	ln.exports = _t()(Object.keys, Object);
});
var yt = c((wS, un) => {
	var tp = Ce(), rp = sn(), op = Object.prototype.hasOwnProperty;
	function ip(t) {
		if (!tp(t)) return rp(t);
		var e = [];
		for (var r in Object(t)) op.call(t, r) && r != "constructor" && e.push(r);
		return e;
	}
	un.exports = ip;
});
...
var xt = c((kS, dn) => {
	var lp = N(), sp = R(), up = "[object AsyncFunction]", cp = "[object Function]", dp = "[object GeneratorFunction]", pp = "[object Proxy]";
	function fp(t) {
		if (!sp(t)) return !1;
		var e = lp(t);
		return e == cp || e == dp || e == up || e == pp;
	}
	dn.exports = fp;
});
var fn = c((SS, pn) => {
	pn.exports = F()["__core-js_shared__"];
});
var hn = c((AS, gn) => {
	var vt = fn(), mn = (function() {
...
var yn = c((qS, _n) => {
	var xp = xt(), vp = hn(), wp = R(), Cp = wt(), kp = /[\\^$.*+?()[\]{}|]/g, Sp = /^\[object .+?Constructor\]$/, Ap = Function.prototype, Tp = Object.prototype, qp = Ap.toString, Ip = Tp.hasOwnProperty, Pp = RegExp("^" + qp.call(Ip).replace(kp, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
	function Hp(t) {
		if (!wp(t) || vp(t)) return !1;
		return (xp(t) ? Pp : Sp).test(Cp(t));
	}
	_n.exports = Hp;
});
var vn = c((IS, xn) => {
...
var kn = c((HS, Cn) => {
	Cn.exports = z()(F(), "DataView");
});
var Qe = c((ES, Sn) => {
	Sn.exports = z()(F(), "Map");
});
var Tn = c((WS, An) => {
	An.exports = z()(F(), "Promise");
});
var Ct = c((FS, qn) => {
	qn.exports = z()(F(), "Set");
});
var Pn = c((OS, In) => {
	In.exports = z()(F(), "WeakMap");
});
var ie = c((DS, Bn) => {
	var kt = kn(), St = Qe(), At = Tn(), Tt = Ct(), qt = Pn(), Dn = N(), oe = wt(), Hn = "[object Map]", Qp = "[object Object]", En = "[object Promise]", Wn = "[object Set]", Fn = "[object WeakMap]", On = "[object DataView]", Yp = oe(kt), Xp = oe(St), ef = oe(At), tf = oe(Tt), rf = oe(qt), G = Dn;
	(kt && G(new kt(/* @__PURE__ */ new ArrayBuffer(1))) != On || St && G(new St()) != Hn || At && G(At.resolve()) != En || Tt && G(new Tt()) != Wn || qt && G(new qt()) != Fn) && (G = function(t) {
		var e = Dn(t), r = e == Qp ? t.constructor : void 0, n = r ? oe(r) : "";
		if (n) switch (n) {
			case Yp: return On;
			case Xp: return Hn;
			case ef: return En;
...
var Ln = c((BS, $n) => {
	var nf = N(), of = B(), af = "[object Arguments]";
	function lf(t) {
		return of(t) && nf(t) == af;
	}
	$n.exports = lf;
...
var ke = c(($S, jn) => {
	var Rn = Ln(), sf = B(), zn = Object.prototype, uf = zn.hasOwnProperty, cf = zn.propertyIsEnumerable;
	jn.exports = Rn((function() {
		return arguments;
	})()) ? Rn : function(t) {
		return sf(t) && uf.call(t, "callee") && !cf.call(t, "callee");
	};
});
var Ye = c((LS, Vn) => {
...
var J = c((RS, Un) => {
	var mf = xt(), gf = Ye();
	function hf(t) {
		return t != null && gf(t.length) && !mf(t);
	}
	Un.exports = hf;
});
var Nn = c((zS, Mn) => {
...
var Ae = c((Se, ae) => {
	var _f = F(), yf = Nn(), Kn = typeof Se == "object" && Se && !Se.nodeType && Se, Gn = Kn && typeof ae == "object" && ae && !ae.nodeType && ae, Jn = Gn && Gn.exports === Kn ? _f.Buffer : void 0;
	ae.exports = (Jn ? Jn.isBuffer : void 0) || yf;
});
var Qn = c((jS, Zn) => {
	var Cf = N(), kf = Ye(), Sf = B(), Af = "[object Arguments]", Tf = "[object Array]", qf = "[object Boolean]", If = "[object Date]", Pf = "[object Error]", Hf = "[object Function]", Ef = "[object Map]", Wf = "[object Number]", Ff = "[object Object]", Of = "[object RegExp]", Df = "[object Set]", Bf = "[object String]", $f = "[object WeakMap]", Lf = "[object ArrayBuffer]", Rf = "[object DataView]", zf = "[object Float32Array]", jf = "[object Float64Array]", Vf = "[object Int8Array]", Uf = "[object Int16Array]", Mf = "[object Int32Array]", Nf = "[object Uint8Array]", Gf = "[object Uint8ClampedArray]", Jf = "[object Uint16Array]", Kf = "[object Uint32Array]", k = {};
	k[zf] = k[jf] = k[Vf] = k[Uf] = k[Mf] = k[Nf] = k[Gf] = k[Jf] = k[Kf] = !0;
	k[Af] = k[Tf] = k[Lf] = k[qf] = k[Rf] = k[If] = k[Pf] = k[Hf] = k[Ef] = k[Wf] = k[Ff] = k[Of] = k[Df] = k[Bf] = k[$f] = !1;
	function Zf(t) {
		return Sf(t) && kf(t.length) && !!k[Cf(t)];
	}
	Zn.exports = Zf;
});
var Te = c((VS, Yn) => {
...
var Xe = c((qe, le) => {
	var Yf = ht(), Xn = typeof qe == "object" && qe && !qe.nodeType && qe, Ie = Xn && typeof le == "object" && le && !le.nodeType && le, It = Ie && Ie.exports === Xn && Yf.process;
	le.exports = (function() {
		try {
			return Ie && Ie.require && Ie.require("util").types || It && It.binding && It.binding("util");
		} catch {}
	})();
});
var et = c((US, ro) => {
	var tm = Qn(), rm = Te(), eo = Xe(), to = eo && eo.isTypedArray;
	ro.exports = to ? rm(to) : tm;
});
var oo = c((MS, no) => {
	var om = yt(), im = ie(), am = ke(), lm = P(), sm = J(), um = Ae(), cm = Ce(), dm = et(), pm = "[object Map]", fm = "[object Set]", gm = Object.prototype.hasOwnProperty;
	function hm(t) {
		if (t == null) return !0;
		if (sm(t) && (lm(t) || typeof t == "string" || typeof t.splice == "function" || um(t) || dm(t) || am(t))) return !t.length;
		var e = im(t);
		if (e == pm || e == fm) return !t.size;
		if (cm(t)) return !om(t).length;
		for (var r in t) if (gm.call(t, r)) return !1;
		return !0;
	}
	no.exports = hm;
});
...
var He = c((JS, so) => {
	var ym = Pe();
	function xm(t, e) {
		for (var r = t.length; r--;) if (ym(t[r][0], e)) return r;
		return -1;
	}
	so.exports = xm;
});
var co = c((KS, uo) => {
	var vm = He(), Cm = Array.prototype.splice;
	function km(t) {
		var e = this.__data__, r = vm(e, t);
		if (r < 0) return !1;
		return r == e.length - 1 ? e.pop() : Cm.call(e, r, 1), --this.size, !0;
	}
	uo.exports = km;
});
var fo = c((ZS, po) => {
...
var bo = c((YS, ho) => {
	var Im = He();
	function Pm(t, e) {
		var r = this.__data__, n = Im(r, t);
		return n < 0 ? (++this.size, r.push([t, e])) : r[n][1] = e, this;
	}
	ho.exports = Pm;
});
var Ee = c((XS, _o) => {
	var Hm = ao(), Em = co(), Wm = fo(), Fm = go(), Om = bo();
	function se(t) {
	...
	se.prototype.clear = Hm;
	se.prototype.delete = Em;
	se.prototype.get = Wm;
	se.prototype.has = Fm;
	se.prototype.set = Om;
	_o.exports = se;
...
var Fo = c((lA, Wo) => {
	var Mm = We(), Nm = "__lodash_hash_undefined__", Jm = Object.prototype.hasOwnProperty;
	function Km(t) {
		var e = this.__data__;
		if (Mm) {
			var r = e[t];
			return r === Nm ? void 0 : r;
		}
...
var Do = c((sA, Oo) => {
	var Zm = We(), Ym = Object.prototype.hasOwnProperty;
	function Xm(t) {
		var e = this.__data__;
		return Zm ? e[t] !== void 0 : Ym.call(e, t);
	}
	Oo.exports = Xm;
});
var $o = c((uA, Bo) => {
	var eg = We(), tg = "__lodash_hash_undefined__";
	function rg(t, e) {
		var r = this.__data__;
		return this.size += this.has(t) ? 0 : 1, r[t] = eg && e === void 0 ? tg : e, this;
	}
	Bo.exports = rg;
});
var Ro = c((cA, Lo) => {
	var ng = Po(), og = Eo(), ig = Fo(), ag = Do(), lg = $o();
	function ue(t) {
		var e = -1, r = t == null ? 0 : t.length;
		for (this.clear(); ++e < r;) {
			var n = t[e];
	...
	ue.prototype.clear = ng;
	ue.prototype.delete = og;
	ue.prototype.get = ig;
	ue.prototype.has = ag;
	ue.prototype.set = lg;
	Lo.exports = ue;
...
var Fe = c((fA, No) => {
	...
	function fg(t, e) {
		var r = t.__data__;
		return pg(e) ? r[typeof e == "string" ? "string" : "hash"] : r.map;
	}
	No.exports = fg;
});
var Jo = c((mA, Go) => {
...
var ei = c((bA, Xo) => {
	var xg = Fe();
	function vg(t, e) {
		var r = xg(this, t), n = r.size;
		return r.set(t, e), this.size += r.size == n ? 0 : 1, this;
	}
	Xo.exports = vg;
});
var tt = c((_A, ti) => {
	var wg = Vo(), Cg = Jo(), kg = Zo(), Sg = Yo(), Ag = ei();
	function ce(t) {
		var e = -1, r = t == null ? 0 : t.length;
		for (this.clear(); ++e < r;) {
			var n = t[e];
	...
	ce.prototype.clear = wg;
	ce.prototype.delete = Cg;
	ce.prototype.get = kg;
	ce.prototype.has = Sg;
	ce.prototype.set = Ag;
	ti.exports = ce;
...
var ni = c((yA, ri) => {
	var Tg = Ee(), qg = Qe(), Ig = tt(), Pg = 200;
	function Hg(t, e) {
		var r = this.__data__;
		if (r instanceof Tg) {
			var n = r.__data__;
			if (!qg || n.length < Pg - 1) return n.push([t, e]), this.size = ++r.size, this;
...
var rt = c((xA, oi) => {
	var Eg = Ee(), Wg = xo(), Fg = wo(), Og = ko(), Dg = Ao(), Bg = ni();
	function de(t) {
		var e = this.__data__ = new Eg(t);
		this.size = e.size;
	}
	de.prototype.clear = Wg;
	de.prototype.delete = Fg;
	de.prototype.get = Og;
	de.prototype.has = Dg;
	de.prototype.set = Bg;
	oi.exports = de;
...
var Pt = c((wA, li) => {
	...
	li.exports = (function() {
		try {
			var t = Lg(Object, "defineProperty");
			return t({}, "", {}), t;
		} catch {}
	})();
});
...
var Et = c((kA, ci) => {
	var jg = Ht(), Vg = Pe(), Mg = Object.prototype.hasOwnProperty;
	function Ng(t, e, r) {
		var n = t[e];
		(!(Mg.call(t, e) && Vg(n, r)) || r === void 0 && !(e in t)) && jg(t, e, r);
	}
	ci.exports = Ng;
});
var pe = c((SA, di) => {
	...
	function Kg(t, e, r, n) {
		...
		for (var o = -1, i = e.length; ++o < i;) {
			...
			s === void 0 && (s = t[a]), l ? Jg(r, a, s) : Gg(r, a, s);
		}
		return r;
	}
	di.exports = Kg;
...
var nt = c((TA, mi) => {
	var Qg = 9007199254740991, Yg = /^(?:0|[1-9]\d*)$/;
	function Xg(t, e) {
		var r = typeof t;
		return e = e ?? Qg, !!e && (r == "number" || r != "symbol" && Yg.test(t)) && t > -1 && t % 1 == 0 && t < e;
	}
	mi.exports = Xg;
});
var Wt = c((qA, gi) => {
	var eh = fi(), th = ke(), rh = P(), nh = Ae(), oh = nt(), ih = et(), lh = Object.prototype.hasOwnProperty;
	function sh(t, e) {
		var r = rh(t), n = !r && th(t), l = !r && !n && nh(t), o = !r && !n && !l && ih(t), i = r || n || l || o, a = i ? eh(t.length, String) : [], s = a.length;
		for (var d in t) (e || lh.call(t, d)) && !(i && (d == "length" || l && (d == "offset" || d == "parent") || o && (d == "buffer" || d == "byteLength" || d == "byteOffset") || oh(d, s))) && a.push(d);
		return a;
	}
	gi.exports = sh;
});
var K = c((IA, hi) => {
	var uh = Wt(), ch = yt(), dh = J();
	function ph(t) {
		return dh(t) ? uh(t) : ch(t);
	}
	hi.exports = ph;
});
var _i = c((PA, bi) => {
...
var wi = c((EA, vi) => {
	var bh = R(), _h = Ce(), yh = xi(), vh = Object.prototype.hasOwnProperty;
	function wh(t) {
		if (!bh(t)) return yh(t);
		var e = _h(t), r = [];
		for (var n in t) n == "constructor" && (e || !vh.call(t, n)) || r.push(n);
		return r;
	}
	vi.exports = wh;
});
var ot = c((WA, Ci) => {
	var Ch = Wt(), kh = wi(), Sh = J();
	function Ah(t) {
		return Sh(t) ? Ch(t, !0) : kh(t);
	}
	Ci.exports = Ah;
});
var Si = c((FA, ki) => {
	var Th = pe(), qh = ot();
	function Ih(t, e) {
		return t && Th(e, qh(e), t);
	}
	ki.exports = Ih;
});
var Pi = c((Oe, fe) => {
	var Ph = F(), Ii = typeof Oe == "object" && Oe && !Oe.nodeType && Oe, Ai = Ii && typeof fe == "object" && fe && !fe.nodeType && fe, Ti = Ai && Ai.exports === Ii ? Ph.Buffer : void 0, qi = Ti ? Ti.allocUnsafe : void 0;
	function Eh(t, e) {
		if (e) return t.slice();
		var r = t.length, n = qi ? qi(r) : new t.constructor(r);
		return t.copy(n), n;
	}
	fe.exports = Eh;
});
...
var Fi = c((DA, Wi) => {
	function Fh(t, e) {
		for (var r = -1, n = t == null ? 0 : t.length, l = 0, o = []; ++r < n;) {
			var i = t[r];
			e(i, r, t) && (o[l++] = i);
		}
		return o;
...
var it = c(($A, Bi) => {
	var Dh = Fi(), Bh = Ft(), Lh = Object.prototype.propertyIsEnumerable, Di = Object.getOwnPropertySymbols;
	Bi.exports = Di ? function(t) {
		return t == null ? [] : (t = Object(t), Dh(Di(t), function(e) {
			return Lh.call(t, e);
		}));
	} : Bh;
});
...
var at = c((RA, Ri) => {
	function Uh(t, e) {
		for (var r = -1, n = e.length, l = t.length; ++r < n;) t[l + r] = e[r];
		return t;
	}
	Ri.exports = Uh;
});
var Ot = c((zA, zi) => {
	var Mh = at(), Nh = Ke(), Gh = it(), Jh = Ft();
	zi.exports = Object.getOwnPropertySymbols ? function(t) {
		for (var e = []; t;) Mh(e, Gh(t)), t = Nh(t);
		return e;
	} : Jh;
});
var Vi = c((jA, ji) => {
...
var Dt = c((VA, Ui) => {
	...
	function rb(t, e, r) {
		var n = e(t);
		return tb(t) ? n : eb(n, r(t));
	}
	Ui.exports = rb;
});
var Bt = c((UA, Mi) => {
	var nb = Dt(), ob = it(), ib = K();
	function ab(t) {
		return nb(t, ib, ob);
	}
	Mi.exports = ab;
...
var Ji = c((NA, Gi) => {
	...
	function fb(t) {
		...
		return e && typeof t[0] == "string" && pb.call(t, "index") && (r.index = t.index, r.input = t.input), r;
	}
	Gi.exports = fb;
});
var Lt = c((GA, Ki) => {
	Ki.exports = F().Uint8Array;
});
var lt = c((JA, Qi) => {
	var Zi = Lt();
	function hb(t) {
...
var ta = c((ZA, ea) => {
	var yb = /\w*$/;
	function xb(t) {
		var e = new t.constructor(t.source, yb.exec(t));
		return e.lastIndex = t.lastIndex, e;
	}
	ea.exports = xb;
});
var aa = c((QA, ia) => {
	var ra = M(), na = ra ? ra.prototype : void 0, oa = na ? na.valueOf : void 0;
	function vb(t) {
		return oa ? Object(oa.call(t)) : {};
	}
	ia.exports = vb;
});
var sa = c((YA, la) => {
	var wb = lt();
	function Cb(t, e) {
		var r = e ? wb(t.buffer) : t.buffer;
		return new t.constructor(r, t.byteOffset, t.length);
	}
	la.exports = Cb;
});
var ca = c((XA, ua) => {
	var kb = lt(), Sb = Xi(), Ab = ta(), Tb = aa(), qb = sa(), Ib = "[object Boolean]", Pb = "[object Date]", Hb = "[object Map]", Eb = "[object Number]", Wb = "[object RegExp]", Fb = "[object Set]", Ob = "[object String]", Db = "[object Symbol]", Bb = "[object ArrayBuffer]", $b = "[object DataView]", Lb = "[object Float32Array]", Rb = "[object Float64Array]", zb = "[object Int8Array]", jb = "[object Int16Array]", Vb = "[object Int32Array]", Ub = "[object Uint8Array]", Mb = "[object Uint8ClampedArray]", Nb = "[object Uint16Array]", Gb = "[object Uint32Array]";
	function Jb(t, e, r) {
		var n = t.constructor;
		switch (e) {
			case Bb: return kb(t);
			case Ib:
			case Pb: return new n(+t);
			case $b: return Sb(t, r);
			case Lb:
			case Rb:
			case zb:
			case jb:
			...
			case Mb:
			case Nb:
			case Gb: return qb(t, r);
			case Hb: return new n();
			case Eb:
			case Ob: return new n(t);
			case Wb: return Ab(t);
			case Fb: return new n();
			case Db: return Tb(t);
		}
	}
	ua.exports = Jb;
...
var ga = c((tT, ma) => {
	var Qb = fa(), Yb = Ke(), Xb = Ce();
	function e_(t) {
		return typeof t.constructor == "function" && !Xb(t) ? Qb(Yb(t)) : {};
	}
	ma.exports = e_;
});
var ba = c((rT, ha) => {
	var t_ = ie(), r_ = B(), n_ = "[object Map]";
	function o_(t) {
		return r_(t) && t_(t) == n_;
	}
	ha.exports = o_;
...
var va = c((nT, xa) => {
	var i_ = ba(), a_ = Te(), _a = Xe(), ya = _a && _a.isMap;
	xa.exports = ya ? a_(ya) : i_;
});
var Ca = c((oT, wa) => {
	var s_ = ie(), u_ = B(), c_ = "[object Set]";
	function d_(t) {
		return u_(t) && s_(t) == c_;
	}
	wa.exports = d_;
...
var Ta = c((iT, Aa) => {
	var p_ = Ca(), f_ = Te(), ka = Xe(), Sa = ka && ka.isSet;
	Aa.exports = Sa ? f_(Sa) : p_;
});
var Ea = c((aT, Ha) => {
	var g_ = rt(), h_ = ai(), b_ = Et(), __ = _i(), y_ = Si(), x_ = Pi(), v_ = Ei(), w_ = Li(), C_ = Vi(), k_ = Bt(), S_ = $t(), A_ = ie(), T_ = Ji(), q_ = ca(), I_ = ga(), P_ = P(), H_ = Ae(), E_ = va(), W_ = R(), F_ = Ta(), O_ = K(), D_ = ot(), B_ = 1, $_ = 2, L_ = 4, qa = "[object Arguments]", R_ = "[object Array]", z_ = "[object Boolean]", j_ = "[object Date]", V_ = "[object Error]", Ia = "[object Function]", U_ = "[object GeneratorFunction]", M_ = "[object Map]", N_ = "[object Number]", Pa = "[object Object]", G_ = "[object RegExp]", J_ = "[object Set]", K_ = "[object String]", Z_ = "[object Symbol]", Q_ = "[object WeakMap]", Y_ = "[object ArrayBuffer]", X_ = "[object DataView]", ey = "[object Float32Array]", ty = "[object Float64Array]", ry = "[object Int8Array]", ny = "[object Int16Array]", oy = "[object Int32Array]", iy = "[object Uint8Array]", ay = "[object Uint8ClampedArray]", ly = "[object Uint16Array]", sy = "[object Uint32Array]", C = {};
	C[qa] = C[R_] = C[Y_] = C[X_] = C[z_] = C[j_] = C[ey] = C[ty] = C[ry] = C[ny] = C[oy] = C[M_] = C[N_] = C[Pa] = C[G_] = C[J_] = C[K_] = C[Z_] = C[iy] = C[ay] = C[ly] = C[sy] = !0;
	C[V_] = C[Ia] = C[Q_] = !1;
	function st(t, e, r, n, l, o) {
		var i, a = e & B_, s = e & $_, d = e & L_;
		if (r && (i = l ? r(t, n, l, o) : r(t)), i !== void 0) return i;
		if (!W_(t)) return t;
		var p = P_(t);
		if (p) {
			if (i = T_(t), !a) return v_(t, i);
		} else {
			var f = A_(t), u = f == Ia || f == U_;
			if (H_(t)) return x_(t, a);
			if (f == Pa || f == qa || u && !l) {
				if (i = s || u ? {} : I_(t), !a) return s ? C_(t, y_(i, t)) : w_(t, __(i, t));
			} else {
				if (!C[f]) return l ? t : {};
				i = q_(t, f, a);
			}
		...
		var m = o.get(t);
		if (m) return m;
		o.set(t, i), F_(t) ? t.forEach(function(_) {
			i.add(st(_, e, r, _, t, o));
		}) : E_(t) && t.forEach(function(_, b) {
			i.set(b, st(_, e, r, b, t, o));
		});
		var h = p ? void 0 : (d ? s ? S_ : k_ : s ? D_ : O_)(t);
		return h_(h || t, function(_, b) {
			h && (b = _, _ = t[b]), b_(i, b, st(_, e, r, b, t, o));
		}), i;
	}
	Ha.exports = st;
});
var ut = c((lT, Wa) => {
	var uy = P(), cy = xe(), dy = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, py = /^\w*$/;
	function fy(t, e) {
		if (uy(t)) return !1;
		var r = typeof t;
		return r == "number" || r == "symbol" || r == "boolean" || t == null || cy(t) ? !0 : py.test(t) || !dy.test(t) || e != null && t in Object(e);
	}
	Wa.exports = fy;
});
var Da = c((sT, Oa) => {
	var Fa = tt(), my = "Expected a function";
	function Rt(t, e) {
		if (typeof t != "function" || e != null && typeof e != "function") throw new TypeError(my);
		var r = function() {
			var n = arguments, l = e ? e.apply(this, n) : n[0], o = r.cache;
			if (o.has(l)) return o.get(l);
			var i = t.apply(this, n);
			return r.cache = o.set(l, i) || o, i;
		};
		return r.cache = new (Rt.Cache || Fa)(), r;
	}
	Rt.Cache = Fa;
	Oa.exports = Rt;
});
...
var Ra = c((cT, La) => {
	var _y = $a(), yy = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, xy = /\\(\\)?/g;
	La.exports = _y(function(t) {
		var e = [];
		return t.charCodeAt(0) === 46 && e.push(""), t.replace(yy, function(r, n, l, o) {
			e.push(l ? o.replace(xy, "$1") : n || r);
		}), e;
	});
});
var De = c((dT, za) => {
	var wy = P(), Cy = ut(), ky = Ra(), Sy = ve();
	function Ay(t, e) {
		return wy(t) ? t : Cy(t, e) ? [t] : ky(Sy(t));
	}
	za.exports = Ay;
});
var Va = c((pT, ja) => {
...
var me = c((fT, Ua) => {
	var qy = xe(), Iy = Infinity;
	function Py(t) {
		if (typeof t == "string" || qy(t)) return t;
		var e = t + "";
		return e == "0" && 1 / t == -Iy ? "-0" : e;
	}
	Ua.exports = Py;
});
var Be = c((mT, Ma) => {
	...
	function Wy(t, e) {
		e = Hy(e, t);
		for (var r = 0, n = e.length; t != null && r < n;) t = t[Ey(e[r++])];
...
var Ga = c((gT, Na) => {
	function Fy(t, e, r) {
		var n = -1, l = t.length;
		e < 0 && (e = -e > l ? 0 : l + e), r = r > l ? l : r, r < 0 && (r += l), l = e > r ? 0 : r - e >>> 0, e >>>= 0;
		for (var o = Array(l); ++n < l;) o[n] = t[n + e];
		return o;
	}
	Na.exports = Fy;
});
var Ka = c((hT, Ja) => {
	var Oy = Be(), Dy = Ga();
	function By(t, e) {
		return e.length < 2 ? t : Oy(t, Dy(e, 0, -1));
	}
	Ja.exports = By;
});
var Ya = c((bT, Qa) => {
	var $y = De(), Ly = Va(), Ry = Ka(), Za = me(), jy = Object.prototype.hasOwnProperty;
	function Vy(t, e) {
		e = $y(e, t);
		var r = -1, n = e.length;
		if (!n) return !0;
		for (; ++r < n;) {
			var l = Za(e[r]);
			if (l === "__proto__" && !jy.call(t, "__proto__") || (l === "constructor" || l === "prototype") && r < n - 1) return !1;
		}
		var o = Ry(t, e);
		return o == null || delete o[Za(Ly(e))];
	}
	Qa.exports = Vy;
});
var el = c((_T, Xa) => {
	var Uy = we();
	function My(t) {
		return Uy(t) ? void 0 : t;
	}
	Xa.exports = My;
});
var ol = c((yT, nl) => {
	var tl = M(), Ny = ke(), Gy = P(), rl = tl ? tl.isConcatSpreadable : void 0;
	function Jy(t) {
		return Gy(t) || Ny(t) || !!(rl && t && t[rl]);
	}
	nl.exports = Jy;
});
var zt = c((xT, al) => {
	var Ky = at(), Zy = ol();
	function il(t, e, r, n, l) {
		var o = -1, i = t.length;
		for (r || (r = Zy), l || (l = []); ++o < i;) {
			var a = t[o];
			e > 0 && r(a) ? e > 1 ? il(a, e - 1, r, n, l) : Ky(l, a) : n || (l[l.length] = a);
		}
		return l;
	}
	al.exports = il;
...
var sl = c((vT, ll) => {
	var Qy = zt();
	function Yy(t) {
		return (t == null ? 0 : t.length) ? Qy(t, 1) : [];
	}
	ll.exports = Yy;
});
var cl = c((wT, ul) => {
...
var jt = c((CT, pl) => {
	var ex = cl(), dl = Math.max;
	function tx(t, e, r) {
		return e = dl(e === void 0 ? t.length - 1 : e, 0), function() {
			for (var n = arguments, l = -1, o = dl(n.length - e, 0), i = Array(o); ++l < o;) i[l] = n[e + l];
			l = -1;
			for (var a = Array(e + 1); ++l < e;) a[l] = n[l];
			return a[e] = r(i), ex(t, this, a);
		};
	}
	pl.exports = tx;
});
...
var _l = c((AT, bl) => {
	var ox = ml(), hl = Pt(), ix = $e();
	bl.exports = hl ? function(t, e) {
...
var xl = c((TT, yl) => {
	var lx = 800, sx = 16, ux = Date.now;
	function cx(t) {
		var e = 0, r = 0;
		return function() {
			var n = ux(), l = sx - (n - r);
			if (r = n, l > 0) {
				if (++e >= lx) return arguments[0];
			} else e = 0;
...
var Cl = c((IT, wl) => {
	var mx = sl(), gx = jt(), hx = Vt();
	function bx(t) {
		return hx(gx(t, void 0, mx), t + "");
	}
	wl.exports = bx;
});
var Sl = c((PT, kl) => {
	var _x = Je(), yx = Ea(), xx = Ya(), vx = De(), wx = pe(), Cx = el(), kx = Cl(), Sx = $t(), Ax = 1, Tx = 2, qx = 4;
	kl.exports = kx(function(t, e) {
		var r = {};
		if (t == null) return r;
		var n = !1;
		e = _x(e, function(o) {
			return o = vx(o, t), n || (n = o.length > 1), o;
		}), wx(t, Sx(t), r), n && (r = yx(r, Ax | Tx | qx, Cx));
		for (var l = e.length; l--;) xx(r, e[l]);
		return r;
	});
});
var Pl = c(($T, Il) => {
	function Wx(t, e, r, n) {
		var l = -1, o = t == null ? 0 : t.length;
		for (n && o && (r = t[++l]); ++l < o;) r = e(r, t[l], l, t);
		return r;
	}
	Il.exports = Wx;
});
...
var Fl = c((RT, Wl) => {
	var Bx = El(), $x = ve(), Lx = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, Mx = RegExp("[\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff]", "g");
	function Nx(t) {
		return t = $x(t), t && t.replace(Lx, Bx).replace(Mx, "");
	}
	Wl.exports = Nx;
});
var Dl = c((zT, Ol) => {
	var Gx = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g;
	function Jx(t) {
		return t.match(Gx) || [];
	}
	Ol.exports = Jx;
...
var $l = c((jT, Bl) => {
	var Kx = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;
	function Zx(t) {
		return Kx.test(t);
	}
	Bl.exports = Zx;
...
var ns = c((VT, rs) => {
	var Vl = "\\ud800-\\udfff", e0 = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", Ul = "\\u2700-\\u27bf", Ml = "a-z\\xdf-\\xf6\\xf8-\\xff", t0 = "\\xac\\xb1\\xd7\\xf7", r0 = "\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf", n0 = "\\u2000-\\u206f", o0 = " \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", Nl = "A-Z\\xc0-\\xd6\\xd8-\\xde", i0 = "\\ufe0e\\ufe0f", Gl = t0 + r0 + n0 + o0, Jl = "['’]", Ll = "[" + Gl + "]", a0 = "[" + e0 + "]", Kl = "\\d+", l0 = "[" + Ul + "]", Zl = "[" + Ml + "]", Ql = "[^" + Vl + Gl + Kl + Ul + Ml + Nl + "]", u0 = "(?:" + a0 + "|\\ud83c[\\udffb-\\udfff])", c0 = "[^" + Vl + "]", Yl = "(?:\\ud83c[\\udde6-\\uddff]){2}", Xl = "[\\ud800-\\udbff][\\udc00-\\udfff]", he = "[" + Nl + "]", d0 = "\\u200d", Rl = "(?:" + Zl + "|" + Ql + ")", p0 = "(?:" + he + "|" + Ql + ")", zl = "(?:" + Jl + "(?:d|ll|m|re|s|t|ve))?", jl = "(?:" + Jl + "(?:D|LL|M|RE|S|T|VE))?", es = u0 + "?", ts = "[" + i0 + "]?", f0 = "(?:" + d0 + "(?:" + [
		c0,
		Yl,
		Xl
	].join("|") + ")" + ts + es + ")*", m0 = "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", g0 = "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", h0 = ts + es + f0, b0 = "(?:" + [
		l0,
		Yl,
		Xl
	].join("|") + ")" + h0, _0 = RegExp([
...
var is = c((UT, os) => {
	var x0 = Dl(), v0 = $l(), w0 = ve(), C0 = ns();
	function k0(t, e, r) {
		return t = w0(t), e = r ? void 0 : e, e === void 0 ? v0(t) ? C0(t) : x0(t) : t.match(e) || [];
	}
	os.exports = k0;
});
var ls = c((MT, as) => {
	var S0 = Pl(), A0 = Fl(), T0 = is(), I0 = RegExp("['’]", "g");
	function P0(t) {
		return function(e) {
			return S0(T0(A0(e).replace(I0, "")), t, "");
		};
	}
	as.exports = P0;
});
var ct = c((NT, ss) => {
	ss.exports = ls()(function(t, e, r) {
...
var Ns = c((eI, Ms) => {
	...
	function Bv(t) {
		return this.__data__.set(t, Dv), this;
	}
	Ms.exports = Bv;
});
var Js = c((tI, Gs) => {
...
var dr = c((rI, Ks) => {
	var Lv = tt(), Rv = Ns(), zv = Js();
	function pt(t) {
		var e = -1, r = t == null ? 0 : t.length;
		for (this.__data__ = new Lv(); ++e < r;) this.add(t[e]);
	}
	pt.prototype.add = pt.prototype.push = Rv;
	pt.prototype.has = zv;
	Ks.exports = pt;
});
var Qs = c((nI, Zs) => {
...
var fr = c((iI, Xs) => {
	var Uv = dr(), Mv = Qs(), Nv = pr(), Gv = 1, Jv = 2;
	function Kv(t, e, r, n, l, o) {
		var i = r & Gv, a = t.length, s = e.length;
		if (a != s && !(i && s > a)) return !1;
		var d = o.get(t), p = o.get(e);
		if (d && p) return d == e && p == t;
		var f = -1, u = !0, m = r & Jv ? new Uv() : void 0;
		for (o.set(t, e), o.set(e, t); ++f < a;) {
			var g = t[f], h = e[f];
			if (n) var _ = i ? n(h, g, f, e, t, o) : n(g, h, f, t, e, o);
			if (_ !== void 0) {
				if (_) continue;
				u = !1;
				break;
			...
			if (m) {
				if (!Mv(e, function(b, y) {
					if (!Nv(m, y) && (g === b || l(g, b, r, n, o))) return m.push(y);
				})) {
					u = !1;
					break;
				}
			} else if (!(g === h || l(g, h, r, n, o))) {
				u = !1;
				break;
			}
		}
...
var lu = c((sI, au) => {
	var nu = M(), ou = Lt(), Yv = Pe(), Xv = fr(), ew = tu(), tw = ft(), rw = 1, nw = 2, ow = "[object Boolean]", iw = "[object Date]", aw = "[object Error]", lw = "[object Map]", sw = "[object Number]", uw = "[object RegExp]", cw = "[object Set]", dw = "[object String]", pw = "[object Symbol]", fw = "[object ArrayBuffer]", mw = "[object DataView]", iu = nu ? nu.prototype : void 0, mr = iu ? iu.valueOf : void 0;
	function gw(t, e, r, n, l, o, i) {
		switch (r) {
			case mw:
				if (t.byteLength != e.byteLength || t.byteOffset != e.byteOffset) return !1;
				t = t.buffer, e = e.buffer;
			case fw: return !(t.byteLength != e.byteLength || !o(new ou(t), new ou(e)));
			case ow:
			case iw:
			case sw: return Yv(+t, +e);
			case aw: return t.name == e.name && t.message == e.message;
			case uw:
			case dw: return t == e + "";
			case lw: var a = ew;
			case cw:
				var s = n & rw;
				if (a || (a = tw), t.size != e.size && !s) return !1;
				var d = i.get(t);
				if (d) return d == e;
				n |= nw, i.set(t, e);
				var p = Xv(a(t), a(e), n, l, o, i);
				return i.delete(t), p;
			case pw: if (mr) return mr.call(t) == mr.call(e);
		}
		return !1;
	}
	au.exports = gw;
...
var cu = c((uI, uu) => {
	var su = Bt(), hw = 1, _w = Object.prototype.hasOwnProperty;
	function yw(t, e, r, n, l, o) {
		var i = r & hw, a = su(t), s = a.length;
		if (s != su(e).length && !i) return !1;
		for (var f = s; f--;) {
			var u = a[f];
			if (!(i ? u in e : _w.call(e, u))) return !1;
		}
		var m = o.get(t), g = o.get(e);
		...
		for (var _ = i; ++f < s;) {
			u = a[f];
			var b = t[u], y = e[u];
			if (n) var v = i ? n(y, b, u, e, t, o) : n(b, y, u, t, e, o);
			if (!(v === void 0 ? b === y || l(b, y, r, n, o) : v)) {
				h = !1;
				break;
			}
			_ || (_ = u == "constructor");
...
var _u = c((cI, bu) => {
	var gr = rt(), xw = fr(), vw = lu(), ww = cu(), du = ie(), pu = P(), fu = Ae(), Cw = et(), kw = 1, mu = "[object Arguments]", gu = "[object Array]", mt = "[object Object]", hu = Object.prototype.hasOwnProperty;
	function Aw(t, e, r, n, l, o) {
		var i = pu(t), a = pu(e), s = i ? gu : du(t), d = a ? gu : du(e);
		s = s == mu ? mt : s, d = d == mu ? mt : d;
		var p = s == mt, f = d == mt, u = s == d;
		if (u && fu(t)) {
			if (!fu(e)) return !1;
			i = !0, p = !1;
		}
		if (u && !p) return o || (o = new gr()), i || Cw(t) ? xw(t, e, r, n, l, o) : vw(t, e, s, r, n, l, o);
		if (!(r & kw)) {
			var m = p && hu.call(t, "__wrapped__"), g = f && hu.call(e, "__wrapped__");
			if (m || g) {
				var h = m ? t.value() : t, _ = g ? e.value() : e;
				return o || (o = new gr()), l(h, _, r, n, o);
			}
		}
		return u ? (o || (o = new gr()), ww(t, e, r, n, l, o)) : !1;
	}
	bu.exports = Aw;
});
var hr = c((dI, vu) => {
	var Tw = _u(), yu = B();
	function xu(t, e, r, n, l) {
		return t === e ? !0 : t == null || e == null || !yu(t) && !yu(e) ? t !== t && e !== e : Tw(t, e, r, n, xu, l);
	}
	vu.exports = xu;
});
var Cu = c((pI, wu) => {
	var qw = rt(), Iw = hr(), Pw = 1, Hw = 2;
	function Ew(t, e, r, n) {
		var l = r.length, o = l, i = !n;
		if (t == null) return !o;
		for (t = Object(t); l--;) {
			var a = r[l];
		...
		for (; ++l < o;) {
			a = r[l];
			var s = a[0], d = t[s], p = a[1];
			if (i && a[2]) {
				if (d === void 0 && !(s in t)) return !1;
			} else {
				var f = new qw();
				if (n) var u = n(d, p, s, t, e, f);
				if (!(u === void 0 ? Iw(p, d, Pw | Hw, n, f) : u)) return !1;
			}
		}
		return !0;
	}
...
var Iu = c((hI, qu) => {
	var Lw = Cu(), Rw = Au(), zw = _r();
	function jw(t) {
		var e = Rw(t);
		return e.length == 1 && e[0][2] ? zw(e[0][0], e[0][1]) : function(r) {
			return r === t || Lw(r, t, e);
		};
	}
	qu.exports = jw;
...
var Ou = c((yI, Fu) => {
	var Nw = De(), Gw = ke(), Jw = P(), Kw = nt(), Zw = Ye(), Qw = me();
	function Yw(t, e, r) {
		e = Nw(e, t);
		for (var n = -1, l = e.length, o = !1; ++n < l;) {
			var i = Qw(e[n]);
			if (!(o = t != null && r(t, i))) break;
			t = t[i];
		}
		return o || ++n != l ? o : (l = t == null ? 0 : t.length, !!l && Zw(l) && Kw(i, l) && (Jw(t) || Gw(t)));
	}
	Fu.exports = Yw;
});
var Bu = c((xI, Du) => {
	var Xw = Wu(), eC = Ou();
	function tC(t, e) {
		return t != null && eC(t, e, Xw);
	}
	Du.exports = tC;
});
var Lu = c((vI, $u) => {
	var rC = hr(), nC = Hu(), oC = Bu(), iC = ut(), aC = br(), lC = _r(), sC = me(), uC = 1, cC = 2;
	function dC(t, e) {
		return iC(t) && aC(e) ? lC(sC(t), e) : function(r) {
			var n = nC(r, t);
			return n === void 0 && n === e ? oC(r, t) : rC(e, n, uC | cC);
		};
	}
	$u.exports = dC;
});
...
var Mu = c((kI, Uu) => {
	var gC = zu(), hC = Vu(), bC = ut(), _C = me();
	function yC(t) {
		return bC(t) ? gC(_C(t)) : hC(t);
	}
	Uu.exports = yC;
});
var yr = c((SI, Nu) => {
	var xC = Iu(), vC = Lu(), wC = $e(), CC = P(), kC = Mu();
	function SC(t) {
		return typeof t == "function" ? t : t == null ? wC : typeof t == "object" ? CC(t) ? vC(t[0], t[1]) : xC(t) : kC(t);
	}
	Nu.exports = SC;
});
var Ju = c((AI, Gu) => {
	function AC(t) {
		return function(e, r, n) {
			for (var l = -1, o = Object(e), i = n(e), a = i.length; a--;) {
				var s = i[t ? a : ++l];
...
var ec = c((II, Xu) => {
	...
	function WC(t, e) {
		return function(r, n) {
			if (r == null) return r;
			if (!EC(r)) return t(r, n);
			for (var l = r.length, o = e ? l : -1, i = Object(r); (e ? o-- : ++o < l) && n(i[o], o, i) !== !1;);
			return r;
		};
	}
	Xu.exports = WC;
...
var uc = c((WI, sc) => {
	...
	function zC(t, e) {
		if (t !== e) {
			var r = t !== void 0, n = t === null, l = t === t, o = lc(t), i = e !== void 0, a = e === null, s = e === e, d = lc(e);
			if (!a && !d && !o && t > e || o && i && s && !a && !d || n && i && s || !r && s || !l) return 1;
			if (!n && !o && !d && t < e || d && r && l && !n && !o || a && r && l || !i && l || !s) return -1;
		}
		return 0;
	}
	sc.exports = zC;
...
var dc = c((FI, cc) => {
	var jC = uc();
	function VC(t, e, r) {
		for (var n = -1, l = t.criteria, o = e.criteria, i = l.length, a = r.length; ++n < i;) {
			var s = jC(l[n], o[n]);
			if (s) {
				if (n >= a) return s;
...
var fc = c((OI, pc) => {
	var xr = Je(), UC = Be(), MC = yr(), NC = oc(), GC = ac(), JC = Te(), KC = dc(), ZC = $e(), QC = P();
	function YC(t, e, r) {
		e.length ? e = xr(e, function(o) {
			return QC(o) ? function(i) {
				return UC(i, o.length === 1 ? o[0] : o);
			} : o;
		}) : e = [ZC];
		var n = -1;
		e = xr(e, JC(MC));
		return GC(NC(t, function(o, i, a) {
			return {
				criteria: xr(e, function(d) {
					return d(o);
				}),
				index: ++n,
				value: o
...
var gc = c((DI, mc) => {
	var XC = $e(), ek = jt(), tk = Vt();
	function rk(t, e) {
		return tk(ek(t, e, XC), t + "");
	}
	mc.exports = rk;
});
var bc = c((BI, hc) => {
	var nk = Pe(), ok = J(), ik = nt(), ak = R();
	function lk(t, e, r) {
		if (!ak(r)) return !1;
		var n = typeof e;
		return (n == "number" ? ok(r) && ik(e, r.length) : n == "string" && e in r) ? nk(r[e], t) : !1;
	}
	hc.exports = lk;
});
var xc = c(($I, yc) => {
	var sk = zt(), uk = fc(), ck = gc(), _c = bc();
	yc.exports = ck(function(t, e) {
		if (t == null) return [];
		var r = e.length;
		return r > 1 && _c(t, e[0], e[1]) ? e = [] : r > 2 && _c(e[0], e[1], e[2]) && (e = [e[0]]), uk(t, sk(e, 1), []);
	});
});
var wc = c((LI, vc) => {
	function pk(t, e, r, n) {
		for (var l = t.length, o = r + (n ? 1 : -1); n ? o-- : ++o < l;) if (e(t[o], o, t)) return o;
		return -1;
	}
	vc.exports = pk;
});
...
var Ac = c((zI, Sc) => {
	function mk(t, e, r) {
		for (var n = r - 1, l = t.length; ++n < l;) if (t[n] === e) return n;
		return -1;
	}
	Sc.exports = mk;
});
var qc = c((jI, Tc) => {
	var gk = wc(), hk = kc(), bk = Ac();
	function _k(t, e, r) {
		return e === e ? bk(t, e, r) : gk(t, hk, r);
	}
	Tc.exports = _k;
});
var Pc = c((VI, Ic) => {
	var yk = qc();
	function xk(t, e) {
		return !!(t == null ? 0 : t.length) && yk(t, e, 0) > -1;
	}
	Ic.exports = xk;
});
var Ec = c((UI, Hc) => {
	function vk(t, e, r) {
		for (var n = -1, l = t == null ? 0 : t.length; ++n < l;) if (r(e, t[n])) return !0;
		return !1;
	}
	Hc.exports = vk;
});
...
var Dc = c((NI, Oc) => {
	var vr = Ct(), Ck = Fc(), kk = ft();
	Oc.exports = vr && 1 / kk(new vr([, -0]))[1] == Infinity ? function(t) {
		return new vr(t);
	} : Ck;
});
var $c = c((GI, Bc) => {
	var Tk = dr(), qk = Pc(), Ik = Ec(), Pk = pr(), Hk = Dc(), Ek = ft(), Wk = 200;
	function Fk(t, e, r) {
		var n = -1, l = qk, o = t.length, i = !0, a = [], s = a;
		if (r) i = !1, l = Ik;
		else if (o >= Wk) {
			var d = e ? null : Hk(t);
			if (d) return Ek(d);
		...
		e: for (; ++n < o;) {
			...
			if (p = r || p !== 0 ? p : 0, i && f === f) {
				for (var u = s.length; u--;) if (s[u] === f) continue e;
				e && s.push(f), a.push(p);
			} else l(s, f, r) || (s !== a && s.push(f), a.push(p));
		}
		return a;
	}
	Bc.exports = Fk;
...
var nn = (t, e, r, n) => {
	...
	return Array.from(new Set(l)).length == 1;
};
function $(t) {
	let r = (typeof t == "string" || typeof t == "number" ? `${t || "0px"}` : "0px").trim().split(/\s+/).map((n) => parseFloat(n));
	return r.length === 0 ? {
		top: void 0,
		right: void 0,
		bottom: void 0,
...
function on(t, e) {
	if (!t) return 0;
	let { top: r, right: n, bottom: l, left: o } = $(t), i = r || 0, a = n || 0, s = o || 0, d = l || 0;
	if (nn(i, a, s, d)) return Math.round(i / (e / 2) * 100) / 2;
	let f = (i + a + s + d) / 4;
	return Math.round(f / (e / 2) * 100) / 2;
}
function Ze(t, e) {
	if (!t) return "";
	let r = e ? " !important" : "";
	return `-webkit-border-radius: ${t + r}; -moz-border-radius: ${t + r};`;
}
var Tl = I(oo());
var Nt = I(Sl());
var Al = I(we());
function Le(t, e = {}) {
	let { deep: r } = e || {};
	return Object.keys(t).reduce((n, l) => {
		if (t[l] === void 0) return n;
		let o = r && (0, Al.default)(t[l]) ? Le(t[l], e) : t[l];
		return {
			...n,
			[l]: o
		};
...
function L(t, { escapeAndOperator: e = !1, escapeLT: r = !0, escapeGT: n = !0, escapeDoubleQuotes: l = !0, escapeSingleQuotes: o = !0 } = {}) {
	if (!(t && typeof t == "string")) return "";
	let i = t;
	return e && (i = i.replace(/&/g, "&amp;")), r && (i = i.replace(/</g, "&lt;")), n && (i = i.replace(/>/g, "&gt;")), l && (i = i.replace(/"/g, "&quot;")), o && (i = i.replace(/'/g, "&#039;")), i;
}
function ge(t) {
	return !t || typeof t != "string" ? "" : t.replace(/\s+/g, " ").trim();
}
function Ut(t, e = {}) {
	return L(t, {
		escapeAndOperator: !1,
		escapeDoubleQuotes: !0,
		escapeGT: !0,
		escapeLT: !0,
...
function ql(t, { shouldEscapeHtml: e = !0, isJSDOM: r = !1 } = {}) {
	let n = e ? Ut : (l) => l;
	return typeof t == "string" || !t ? {
		...
		let { attrs: l, values: o } = t, i = Z("onClick", l, o) || void 0;
		if (typeof i == "function" && (i = `${i}`), i && !(i.startsWith("function") || i.match(/\(([a-zA-Z0-9_,=\'\"\`\{\}:\s]?)+\)\s+=>/) || i.match(/[a-zA-Z0-9_]+\(([a-zA-Z0-9_,=\'\"\`\{\}:\s]?)+\)\s+\{/) || i.match(/[a-zA-Z0-9]+\s+=>/)) && Object.keys(t.values || {}).length && Object.keys(t.values || {}).some((u) => i?.includes(u)) && !l?.onClick?.match(/\{\{[a-zA-Z_]+\}\}/) && (i = `function({${Object.keys(t.values || {}).join(",")}}) {${i}}`), i && !i.startsWith("function") && i.match(/[a-zA-Z0-9_]+\s*\(([a-zA-Z0-9_,=\'\"\`\{\}:\s]?)+\)\s*\{/) && (i = i.replace(/([a-zA-Z0-9_]+\s*)(\(([a-zA-Z0-9_,=\'\"\`\{\}:\s]?)+\)\s*\{)/, "function$2")), i && i.startsWith("function") && i.match(/[a-zA-Z0-9_]+\s*\([\s\{\,}]*\)\s*\{/) && (i = i.replace(/([a-zA-Z0-9_]+\s*\([\s\{\,}]*\)\s*\{\s*)(.+)(\s*\}[\s;]*)/, "$2").trim()), i && (i.startsWith("function") || i.match(/\(([a-zA-Z0-9_,=\'\"\`\{\}:\s]?)+\)\s+=>/) || i.match(/[a-zA-Z0-9]+\s+=>/))) {
			let u = Object.keys(t.values || {}).map((m) => {
				let g = m === "class" ? " " : ",", h = t.values[m];
				return `${m}:"${Array.isArray(h) ? h.map(Q).join(g) : Q(h)}"`;
			}).join(",");
			i = `(${i})({${u}})`;
		}
		let a = Z("href", l, o) || "", s = Ex(l, o);
		if (Object.keys(l || {}).some((u) => Mt(u) && u.startsWith("data-") && !u.startsWith("+")) && Object.keys(s).every((m) => {
			let g = s[m];
			if (!g) return !0;
		...
		let p = {
			...s,
			href: n(a) || (i ? "#" : void 0),
			target: n(Z("target", l, o)) || (i ? void 0 : "_blank"),
			onClick: Hx(n(i)) || void 0,
			[r ? "className" : "class"]: n(Z("class", l, o)) || void 0,
			download: Z("download", l, o) === "true" || Z("download", l, o) === !0 ? "true" : void 0
		};
		return Object.keys(l || {}).some((u) => Mt(u) && u.startsWith("data-") && !u.startsWith("+")) && Object.keys(s).every((m) => !s[m] || s[m].trim() === "") && !a && !i ? {} : Le(p);
	})();
}
function S(t, e = { href: "" }, { isJSDOM: r = !1 } = {}) {
	let n = {
		...(0, Nt.default)(t?.customAttrs, ["onClick"]),
		href: t?.url || void 0,
		target: t?.target || void 0,
		onclick: t?.onClick || void 0,
		[r ? "className" : "class"]: t?.class || void 0
	};
	return t?.customAttrs && Object.keys(t.customAttrs).length > 0 && Object.keys(t.customAttrs).every((i) => !t.customAttrs[i] || t.customAttrs[i].trim() === "") && !t?.url && !t?.onClick ? {} : {
		...e,
		...Le(n)
	};
}
function A(t) {
	if (!t) return !0;
	let e = (0, Nt.default)({ ...t }, ["target"]);
	return e.href || delete e.href, e.onclick || delete e.onclick, e.onClick || delete e.onClick, !!(0, Tl.default)(Le(e));
}
function Z(t, e, r) {
	let n = `${(e && e[t]) ?? ""}`, l = e && e[`+${t}`];
	if (l) {
		let i = n.startsWith("#") && (l.startsWith("?") || l.startsWith("&")) ? "" : l.startsWith("?") && n.includes("?") ? l.replace("?", "&") : l.startsWith("&") && !n.includes("?") ? l.replace("&", "?") : l;
		n = `${n ?? ""}${i ?? ""}`;
	}
	if (!n) return `${r && r[t] || ""}`;
	let o = n;
	if (Object.entries(r || {}).forEach(([i, a]) => {
		let s = (m, g = ["{", "}"]) => Array.from(m).map((h) => g.includes(h) ? h : encodeURIComponent(h)).join(""), d = (m) => s(m, ["{", "}"]), p = t === "class" ? " " : ",", f = Array.isArray(a) ? a.map(Q).map(d).join(p) : Q(a), u = Array.isArray(a) ? a.map(Q).map(d).join(p) : d(Q(a));
		o = o.replace(new RegExp(`{{${i}}}`, "g"), (m, g) => n.indexOf("?") >= 0 && g > n.indexOf("?") || g > (n.match(/&(?!amp;)/)?.index ?? Infinity) ? u : f);
	}), t === "href") {
		if (o.startsWith("mailto:") && (o = o.replace(/([\?&]?)([\w]+)=(&|$)/gi, "$1")), o = o.replace(/[?&]$/, ""), !o || o.trim() === "") return;
		if ([
			"{{href}}",
			"{{url}}",
			"{{custom}}"
		].includes(o) && n.includes(o)) {
			let a = o.slice(2, -2);
			if (!Q(r?.[a])) return;
		}
	}
...
function Ex(t, e) {
	return t ? Object.keys(t).reduce((r, n) => Mt(n) && n.startsWith("data-") && !n.startsWith("+") ? {
		...r,
		[Ut(n)]: Ut(`${Z(n, t, e) || e[n] || ""}`)
	} : r, {}) : {};
}
var Q = (t) => typeof t == "number" ? `${t}` : `${(t && typeof t == "object" && "value" in t ? t?.value : void 0) ?? t ?? ""}`;
var us = I(ct());
function T(t, { kebab: e = !1 } = {}) {
	return t ? Object.entries(t).reduce((r, [n, l]) => {
		if (l == null) return r;
		return `${r} ${e ? (0, us.default)(n) : n}="${l}"`.trim();
	}, "") : "";
}
var cs = I(ct());
function be(t) {
	return t ? Object.entries(t).reduce((e, [r, n]) => n == null ? e : `${e} ${(0, cs.default)(r)}: ${n};`.trim(), "") : "";
}
function Gt(t) {
	let e = t.toString(16);
...
function W0(t, e, r) {
	return `#${Gt(t)}${Gt(e)}${Gt(r)}`;
}
function F0(t) {
	let e = 100;
	if (t.indexOf("rgba") > -1) {
		let r = t.replace("rgba(", "").replace(")", "").split(",");
		e = parseFloat(r[3]) * 100;
	}
	return e;
}
function j(t) {
	if (!t || typeof t != "string" || !t.includes("rgb")) return t;
	if (F0(t) < 100) return "";
	let e = t.replace("rgba(", "").replace(")", "").split(",");
	return W0(parseFloat(e[0]), parseFloat(e[1]), parseFloat(e[2]));
}
function Y(t, e) {
	return t ? [
		"heading",
		"button",
		"paragraph"
	].includes(t) ? typeof e?.textJson == "string" : t === "table" ? [
		...e?.table?.headers || [],
		...e?.table?.rows || [],
		...e?.table?.footers || []
	].some((l) => l.cells?.some((o) => typeof o?.textJson == "string")) : !1 : !1;
}
var ds = function(t) {
	t || (t = {});
	var e, r = "";
	...
	{
		let { bgcolor: o, border: i, borderRadius: a, linkAttrs: s, text: d, values: p, width: f } = t || {};
		r += `
<div class="v-text-align" style="text-align: ` + ((e = p.textAlign) == null ? "" : e) + `;">
  <a ` + ((e = T(s)) == null ? "" : e) + " class=\"v-size-width v-line-height v-padding v-button-colors v-border v-border-radius v-font-family v-font-size v-font-weight v-letter-spacing\" style=\"color:" + ((e = p.buttonColors.color) == null ? "" : e) + ";background-color:" + ((e = o) == null ? "" : e) + ";", a && (r += (e = a) == null ? "" : e), r += "line-height:" + ((e = p.lineHeight) == null ? "" : e) + ";display:inline-block;text-decoration:none;text-align:center;padding:" + ((e = p.padding) == null ? "" : e) + ";width:" + ((e = f || "auto") == null ? "" : e) + ";max-width:100%;word-wrap:break-word;", i && (r += (e = i) == null ? "" : e), p.fontFamily && (r += "font-family: " + ((e = p.fontFamily?.value) == null ? "" : e) + "; "), r += "font-size: " + ((e = p.fontSize) == null ? "" : e) + ";", p.fontWeight && (r += "font-weight: " + ((e = p.fontWeight) == null ? "" : e) + "; "), p.letterSpacing && (r += "letter-spacing: " + ((e = p.letterSpacing) == null ? "" : e) + "; "), r += `">
    ` + ((e = d) == null ? "" : e) + `
  </a>
</div>
`;
...
var O0 = function(t) {
	...
	Array.prototype.join;
	{
		let { arcsize: o, bgcolor: i, border: a, borderRadius: s, borderTopColor: d, borderTopWidth: p, calculatedHeight: f, calculatedWidth: u, linkAttrs: m, parentHasBackgroundImage: g, text: h, textDirection: _, values: b, width: y } = t || {};
		r += `
  <!--[if mso]><style>.v-button {background: transparent !important;}</style><![endif]-->
<div class="v-text-align" align="` + ((e = b.textAlign) == null ? "" : e) + `">
  `, g ? r += "<!--[if mso]><table role=\"presentation\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr><td align=\"center\" bgcolor=\"" + ((e = b.buttonColors.backgroundColor) == null ? "" : e) + "\" style=\"padding:" + ((e = b.padding) == null ? "" : e) + ";\" valign=\"top\"><![endif]-->" : (r += "<!--[if mso]><v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"" + ((e = m.href || "") == null ? "" : e) + "\" style=\"height:" + ((e = f) == null ? "" : e) + "px; v-text-anchor:middle; width:" + ((e = u) == null ? "" : e) + "px;\" arcsize=\"" + ((e = o) == null ? "" : e) + "%\" ", d && p > 0 ? r += " strokecolor=\"" + ((e = d) == null ? "" : e) + "\" strokeweight=\"" + ((e = p) == null ? "" : e) + "px\"" : r += " stroke=\"f\"", r += " fillcolor=\"" + ((e = i) == null ? "" : e) + "\"><w:anchorlock/><center style=\"color:" + ((e = b.buttonColors.color) == null ? "" : e) + ";", b.fontFamily && (r += "font-family: " + ((e = b.fontFamily?.value) == null ? "" : e) + "; "), r += "\"><![endif]-->"), r += `
    <a ` + ((e = T(m)) == null ? "" : e) + " class=\"v-button v-size-width v-button-colors v-border v-border-radius v-font-family v-font-size v-font-weight v-letter-spacing\" style=\"box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: " + ((e = b.buttonColors.color) == null ? "" : e) + "; background-color: " + ((e = b.buttonColors.backgroundColor) == null ? "" : e) + ";", s && (r += " " + ((e = s) == null ? "" : e)), r += " width:" + ((e = y || "auto") == null ? "" : e) + "; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;", a && (r += (e = a) == null ? "" : e), b.fontFamily && (r += "font-family: " + ((e = b.fontFamily?.value) == null ? "" : e) + "; "), r += "font-size: " + ((e = b.fontSize) == null ? "" : e) + ";", b.fontWeight && (r += "font-weight: " + ((e = b.fontWeight) == null ? "" : e) + "; "), b.letterSpacing && (r += "letter-spacing: " + ((e = b.letterSpacing) == null ? "" : e) + "; "), r += "\"", _ && (r += " dir=\"" + ((e = _) == null ? "" : e) + "\" "), r += `>
      <span class="v-line-height v-padding" style="display:block;padding:` + ((e = b.padding) == null ? "" : e) + ";line-height:" + ((e = b.lineHeight) == null ? "" : e) + ";\">" + ((e = h) == null ? "" : e) + `</span>
    </a>
    `, g ? r += "<!--[if mso]></td></tr></table><![endif]-->" : r += "<!--[if mso]></center></v:roundrect><![endif]-->", r += `
</div>
`;
	}
	return r;
...
var Kt = {
	web(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s } = a || {};
		t.border = t.border || {}, t.buttonColors = t.buttonColors || {}, t.size = t.size || {};
		let d = t.buttonColors.backgroundColor, p = be(t.border), f = t.borderRadius && `border-radius: ${t.borderRadius};`, m = Y("button", t) ? s?.generateHtmlFromTextJson?.(t.textJson) || "" : (0, Jt.default)(t.text), g = t?._processedText || (s?.toSafeHtml ? s.toSafeHtml(m) : m) || "", h = t.size.width && !t.size.autoWidth ? t.size.width : "auto";
		return ds({
			bgcolor: d,
			border: p,
			borderRadius: f,
	...
	email(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s } = a || {};
		t.border = t.border || {}, t.buttonColors = t.buttonColors || {}, t.size = t.size || {};
		let d = j(t.buttonColors.backgroundColor), p = be(t.border), f = j(t.border.borderTopColor), u = parseInt(t.border.borderTopWidth) || 0, m = t.calculatedWidth || 120, g = t.calculatedHeight || 45, h = t.borderRadius && `border-radius: ${t.borderRadius};` + Ze(t.borderRadius), _ = on(t.borderRadius, g), y = Y("button", t) ? s?.generateHtmlFromTextJson?.(t.textJson) || "" : (0, Jt.default)(t.text), v = (s?.toSafeHtml ? s.toSafeHtml(y) : y) || "", w = t.size.width && !t.size.autoWidth ? t.size.width : "auto", x = o?.backgroundImage?.url, q = S(t.href);
		delete q.onclick;
		return O0({
			arcsize: _,
			bgcolor: d,
			...
			values: t,
			width: w,
			parentHasBackgroundImage: x,
			textDirection: v.includes("dir=\"") ? void 0 : s?.textDirection
		});
	},
	classic(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s } = a || {}, d = t.buttonColors.backgroundColor, p = be(t.border), f = Y("button", t) ? s?.generateHtmlFromTextJson?.(t.textJson) || "" : t.text || "", u = t?._processedText || (s?.toSafeHtml ? s.toSafeHtml(f) : f) || "", m = t.size.width && !t.size.autoWidth ? t.size.width : "auto";
		return ds({
			bgcolor: d,
			border: p,
			linkAttrs: S(t.href),
...
var D0 = function(t) {
	...
	Array.prototype.join;
	{
		let { hoverBackgroundColor: o, hoverColor: i, values: a } = t || {};
		r += `
  `, (i || o) && (r += `
  #` + ((e = a._meta.htmlID) == null ? "" : e) + ` a:hover {
    `, i && (r += `
    color: ` + ((e = i) == null ? "" : e) + ` !important;
    `), r += `

    `, o && (r += `
    background-color: ` + ((e = o) == null ? "" : e) + ` !important;
    `), r += `
  }
  `), r += `
`;
...
var ps = { css(t, e, { displayMode: r, headConfig: n }) {
	let l = !n?.hasFeature?.("legacy.disableHoverButtonColors") && r !== "email";
	return D0({
		values: t,
		hoverColor: l ? t.buttonColors.hoverColor : void 0,
		hoverBackgroundColor: l ? t.buttonColors.hoverBackgroundColor : void 0
	});
} };
var Zt = (t) => {
	let { values: { border: e, width: r, textAlign: n } } = t, l = {
		width: r,
		display: "inline-block"
	};
	return e && (l = {
		...e ? typeof e == "object" ? e : { borderTop: e } : {},
		...l,
		lineHeight: e?.borderTopWidth ?? 1,
		height: "0px",
		...
		"aria-label": "divider"
	}, import_react.createElement("div", { style: l }, " "));
};
function O(t) {
	let e = (0, import_server_browser.renderToStaticMarkup)(t);
	return e = e.replace(/<link rel="preload" as="image"[^>]*\/?>/g, ""), e;
}
var $0 = function(t) {
	t || (t = {});
	var e, r = "";
	{
		let { values: n } = t || {};
		r += `
  <table role="presentation" aria-label="divider" align="` + ((e = n.textAlign) == null ? "" : e) + "\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"" + ((e = n.width) == null ? "" : e) + `" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
    <tbody>
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;border-top: ` + ((e = n.border.borderTopWidth) == null ? "" : e) + " " + ((e = n.border.borderTopStyle) == null ? "" : e) + " " + ((e = n.border.borderTopColor) == null ? "" : e) + `;font-size: 0px;line-height: 0px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
          <!--[if gte mso 15]>&nbsp;<![endif]-->
        </td>
      </tr>
    </tbody>
...
var Re = {
	web(t) {
		return O(import_react.createElement(Zt, {
			values: t,
			displayMode: "web"
		}));
	},
	email(t) {
		return t.border = t.border && typeof t.border == "object" ? t.border : {}, $0({ values: t });
	},
	ampWeb(...t) {
		return Re.ampEmail?.(...t) || "";
	},
	ampEmail(...t) {
		return Re.web?.(...t) || "";
	},
...
var L0 = function(t) {
	...
	Array.prototype.join;
	{
		let { text: o, values: i } = t || {};
		r += `
  <` + ((e = i.headingType) == null ? "" : e) + " class=\"v-color v-text-align v-line-height v-font-size v-font-weight v-letter-spacing\" style=\"margin: 0px; ", i.color && (r += "color: " + ((e = i.color) == null ? "" : e) + "; "), r += "line-height: " + ((e = i.lineHeight) == null ? "" : e) + "; text-align: " + ((e = i.textAlign) == null ? "" : e) + "; word-wrap: break-word; ", i.fontFamily && (r += "font-family: " + ((e = i.fontFamily?.value) == null ? "" : e) + "; "), i.letterSpacing && (r += "letter-spacing: " + ((e = i.letterSpacing) == null ? "" : e) + "; "), r += "font-size: " + ((e = i.fontSize) == null ? "" : e) + "; font-weight: " + ((e = i.fontWeight || "400") == null ? "" : e) + ";\">" + ((e = o) == null ? "" : e) + "</" + ((e = i.headingType) == null ? "" : e) + `>
`;
	}
	return r;
};
var R0 = function(t) {
	...
	Array.prototype.join;
	{
		let { text: o, textDirection: i, values: a } = t || {};
		r += `
  <!--[if mso]><table role="presentation" width="100%"><tr><td><![endif]-->
    <` + ((e = a.headingType) == null ? "" : e) + " class=\"v-color v-text-align v-line-height v-font-size v-font-weight v-letter-spacing\" style=\"margin: 0px; ", a.color && (r += "color: " + ((e = a.color) == null ? "" : e) + "; "), r += "line-height: " + ((e = a.lineHeight) == null ? "" : e) + "; text-align: " + ((e = a.textAlign) == null ? "" : e) + "; word-wrap: break-word; ", a.fontFamily && (r += "font-family: " + ((e = a.fontFamily?.value) == null ? "" : e) + "; "), a.letterSpacing && (r += "letter-spacing: " + ((e = a.letterSpacing) == null ? "" : e) + "; "), r += "font-size: " + ((e = a.fontSize) == null ? "" : e) + "; font-weight: " + ((e = a.fontWeight || "400") == null ? "" : e) + ";\"", i && (r += " dir=\"" + ((e = i) == null ? "" : e) + "\" "), r += ">" + ((e = o) == null ? "" : e) + "</" + ((e = a.headingType) == null ? "" : e) + `>
...
var Qt = {
	web(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s } = a || {}, d = Y("heading", t) ? s?.generateHtmlFromTextJson?.(t.textJson) || "" : t.text || "";
		return L0({
			values: t,
			text: W(s?.toSafeHtml ? s.toSafeHtml(d) : d || "")
		});
	},
	email(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s } = a || {}, d = Y("heading", t) ? s?.generateHtmlFromTextJson?.(t.textJson) || "" : t.text || "", p = W(s?.toSafeHtml ? s.toSafeHtml(d) : d || "");
		return R0({
			values: t,
			text: p,
			textDirection: p.includes("dir=\"") ? void 0 : s?.textDirection
		});
	},
	document(...t) {
		return Qt.web?.(...t) || "";
...
var z0 = function(t) {
	...
	Array.prototype.join;
	{
		let { linkColorChanged: o, linkUnderlineChanged: i, values: a } = t || {};
		r += `
  #` + ((e = a._meta.htmlID) == null ? "" : e) + ` a {
    `, o && (r += "color: " + ((e = a.linkStyle.linkColor) == null ? "" : e) + ";"), r += `
    `, i && (r += "text-decoration: " + ((e = a.linkStyle.linkUnderline ? "underline" : "none") == null ? "" : e) + ";"), r += `
  }
`;
	}
	return r;
...
var j0 = function(t) {
	...
	Array.prototype.join;
	{
		let { linkHoverColorChanged: o, linkHoverUnderlineChanged: i, values: a } = t || {};
		r += `
  #` + ((e = a._meta.htmlID) == null ? "" : e) + ` a:hover {
    `, o && (r += "color: " + ((e = a.linkStyle.linkHoverColor) == null ? "" : e) + ";"), r += `
    `, i && (r += "text-decoration: " + ((e = a.linkStyle.linkHoverUnderline ? "underline" : "none") == null ? "" : e) + ";"), r += `
  }
`;
	}
	return r;
};
var gs = { css(t, e, { displayMode: r }) {
	let n = { ...t }, l = { ...e };
	l.linkStyle = l.linkStyle || {}, n.linkStyle = n.linkStyle || {};
	let { linkStyle: o } = n;
	if (o.inherit) return;
	let i = !!o.linkColor && o.linkColor != l.linkStyle.linkColor, a = o.linkUnderline !== null && o.linkUnderline !== l.linkStyle.linkUnderline, s = i || a, d = !!o.linkHoverColor && o.linkHoverColor != l.linkStyle.linkHoverColor, p = o.linkHoverUnderline !== null && o.linkHoverUnderline !== o.linkUnderline, f = d || p, u = [];
	if (s && u.push(z0({
		values: n,
		linkColorChanged: i,
		linkUnderlineChanged: a
	})), r == "web" && f && u.push(j0({
		values: n,
		linkHoverColorChanged: d,
		linkHoverUnderlineChanged: p
	})), u.length > 0) return u.join(`
`);
} };
var hs = (t) => {
	let { values: e, exporterConfig: r } = t, l = { __html: r?.toSafeHtml ? r.toSafeHtml(e.html) : e.html };
	return import_react.createElement("div", { dangerouslySetInnerHTML: l });
};
var V0 = function(t) {
	t || (t = {});
	var e, r = "";
...
var bs = {
	web(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s } = a || {};
		return O(import_react.createElement(hs, {
			values: t,
			exporterConfig: s
		}));
	},
	email(t, e, r, n, l, o, i, a) {
		...
		return V0({
			values: t,
			html: s?.toSafeHtml ? s?.toSafeHtml(t.html) : t.html
		});
	},
	classic(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s } = a || {};
...
function E(t, e = 2) {
	...
	let r = parseFloat(`${t}`);
	if (!Number.isNaN(r)) return parseFloat(r.toFixed(e));
}
function ze(t, { decimalsPlace: e = 2 } = {}) {
	let r = E(t, e);
	if (typeof r == "number" && !Number.isNaN(r)) {
		if (typeof t == "number") return `${r}px`;
		if (typeof t == "string" && t.endsWith("px")) return `${r}px`;
		if (typeof t == "string" && t.endsWith("%")) return `${r}%`;
	}
}
function X(t, e, r = {}) {
	let { decimalsPlace: n = 2, ifNumberConsiderAsPercentage: l = !1 } = r;
	if (typeof t == "number") return l ? X(`${t * 100}%`, e, { decimalsPlace: n }) : E(Math.min(t, e ?? Infinity), n);
	if (typeof t == "string" && t.endsWith("px")) return X(parseFloat(t), e, r);
	if (e && typeof t == "string" && t.endsWith("%")) return X(e * parseFloat(t) / 100, void 0, r);
}
function ee(t, { displayMode: e }) {
	if (e === "email" && !M0) return;
	let { size: r, customSize: n } = t || {};
	if (r === "contain") return "contain";
	if (r === "cover") return "cover";
	if (r === "custom" && (0, _s.default)(n)) return n.map((l) => l ?? "auto").join(" ");
}
var ys = I(we());
function je(t) {
	let r = (typeof t == "string" || typeof t == "number" ? `${t || "0px"}`.trim() : t && (0, ys.default)(t) ? [
		`${t.borderTopWidth || "0px"}`.trim(),
		`${t.borderRightWidth || "0px"}`.trim(),
		`${t.borderBottomWidth || "0px"}`.trim(),
		`${t.borderLeftWidth || "0px"}`.trim()
	].join(" ") : "0px").split(/\s+/).map((n) => parseFloat(n));
	return r.length === 0 ? {
		top: void 0,
		right: void 0,
		bottom: void 0,
...
function V(t) {
	return !`${t?.contentWidth}`.endsWith("%");
}
function N0({ body: t, fallbackBodyContentWidth: e = 500 }) {
	let r = parseFloat(`${t?.values?.contentWidth || 0}`) == t?.values?.contentWidth || `${t?.values?.contentWidth}`.endsWith("px") ? parseFloat(`${t?.values?.contentWidth || 0}`) : e, n = $(t?.values?.padding), l = je(t?.values?.border);
	return r - (n.left || 0) - (n.right || 0) - (l.left || 0) - (l.right || 0);
}
function G0({ body: t, row: e }) {
	let r = N0({ body: t }), n = $(e?.values?.padding), l = je(e?.values?.border);
	return r - (n.left || 0) - (n.right || 0) - (l.left || 0) - (l.right || 0);
}
function J0({ body: t, row: e, column: r }) {
	let n = G0({
		body: t,
		row: e
	}), l = e?.cells?.reduce((d, p) => d + p, 0) || 1, i = (e?.cells?.[r?.index] || 1) / l * n, a = $(r?.values?.padding), s = je(r?.values?.border);
	return i - (a.left || 0) - (a.right || 0) - (s.left || 0) - (s.right || 0);
}
function K0({ body: t, row: e, column: r, item: n }) {
	let l = J0({
		body: t,
		row: e,
		column: r
	}), o = $(n?.values?.containerPadding), i = je(n?.values?.border);
	return l - (o.left || 0) - (o.right || 0) - (i.left || 0) - (i.right || 0);
}
function H({ values: t, columnIndex: e, columnValues: r, rowCells: n, rowValues: l, bodyValues: o }) {
	return K0({
		body: { values: o },
		row: {
			cells: n,
...
function Z0(t, e) {
	let { autoWidth: r = !0, maxWidth: n, width: l } = t || {}, o = r ? void 0 : ze(n) || void 0;
	return {
		width: o || "100%",
		maxWidth: o && e ? ze(X(o, e)) : ze(o || (e && l && l > e ? e : l) || "100%")
	};
}
function D(t, e, r = "src") {
	let { width: n, maxWidth: l } = Z0(t, e);
	return {
		imageCSSClassName: [r === "width" ? "v-width" : `v-${r}-width`, (0, Xt.default)(r) === "max-width" ? "v-max-width" : `v-${(0, Xt.default)(r)}-max-width`].filter(Boolean).join(" "),
		imageStyleObj: {
			width: n,
			maxWidth: l
		},
		imageCSSStyle: [n && `width: ${n};`, l && `max-width: ${l};`].filter(Boolean).join("")
	};
}
function Ve(t, e) {
	if (!(t && typeof t == "string") || !e.dynamic) return t;
	let r = typeof e.resizeWidth == "number" || typeof e.resizeWidth == "string" && e.resizeWidth.endsWith("px") ? E(e.resizeWidth) : void 0;
	if (!(r && r > 0)) return t;
	let n = typeof e.originalWidth == "number" || typeof e.originalWidth == "string" && e.originalWidth.endsWith("px") ? E(e.originalWidth) : void 0, l = e.allowUpscale === !0, o = r * 2, i = o && n ? l ? o : Math.min(o, n) : o;
	if (i === n) return t;
	try {
		let a = new URL(t), s = ze(i);
		return a.searchParams.set("w", s), a.toString();
	} catch {
		return t;
	}
}
var Q0 = function(t) {
	...
	Array.prototype.join;
	{
		let { altText: o, imageCSSClassName: i, imageCSSStyle: a, linkAttrs: s, src: d, values: p } = t || {};
		r += `
<div class="v-text-align" style="position:relative;line-height:0px;text-align:` + ((e = p.textAlign) == null ? "" : e) + `">
  `, A(s) || (r += "<a " + ((e = T(s)) == null ? "" : e) + ">"), r += `
  <img alt="` + ((e = o) == null ? "" : e) + "\" class=\"" + ((e = i) == null ? "" : e) + "\" src=\"" + ((e = d) == null ? "" : e) + "\" style=\"" + ((e = a) == null ? "" : e) + "\" title=\"" + ((e = o) == null ? "" : e) + `"/>
  `, A(s) || (r += "</a>"), r += `
</div>
`;
	}
...
var Y0 = function(t) {
	...
	Array.prototype.join;
	{
		let { altText: o, height: i, imageCSSClassName: a, imageCSSStyle: s, linkAttrs: d, src: p, values: f, width: u } = t || {};
		r += `
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="` + ((e = f.textAlign) == null ? "" : e) + `">
      `, A(d) || (r += "<a " + ((e = T(d)) == null ? "" : e) + ">"), r += `
      <img align="` + ((e = f.textAlign) == null ? "" : e) + "\" border=\"0\" src=\"" + ((e = p) == null ? "" : e) + "\" alt=\"" + ((e = o) == null ? "" : e) + "\" title=\"" + ((e = o) == null ? "" : e) + "\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;" + ((e = s) == null ? "" : e) + "\"", u && (r += " width=\"" + ((e = u) == null ? "" : e) + "\""), i && (r += " height=\"" + ((e = i) == null ? "" : e) + "\""), a && (r += " class=\"" + ((e = a) == null ? "" : e) + "\""), r += `/>
      `, A(d) || (r += "</a>"), r += `
    </td>
  </tr>
</table>
...
var X0 = function(t) {
	...
	Array.prototype.join;
	{
		let { imageCSSClassName: o, linkAttrs: i, values: a } = t || {};
		r += `
<div style="position:relative;line-height:0px;text-align:` + ((e = a.textAlign) == null ? "" : e) + `">
  `, A(i) || (r += "<a " + ((e = T(i)) == null ? "" : e) + ">"), r += `
  <amp-img
    alt="` + ((e = a.altText) == null ? "" : e) + `"
    src="` + ((e = a.src.url) == null ? "" : e) + `"
    width="` + ((e = a.src.width) == null ? "" : e) + `"
    height="` + ((e = a.src.height) == null ? "" : e) + `"
    layout="responsive"
    class="` + ((e = o) == null ? "" : e) + `"
  >
  </amp-img>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="` + ((e = a.textAlign) == null ? "" : e) + `">
      `, A(i) || (r += "<a " + ((e = T(i)) == null ? "" : e) + ">"), r += `
      <amp-img
        alt="` + ((e = a.altText) == null ? "" : e) + `"
        src="` + ((e = a.src.url) == null ? "" : e) + `"
...
var tv = function(t) {
	...
	Array.prototype.join;
	{
		let { altText: o, imageCSSClassName: i, imageCSSStyle: a, isLinkAttrEmpty: s, linkAttrs: d, objectToHtmlAttrs: p, src: f, values: u } = t || {};
		r += `
<div class="v-text-align" style="position:relative;line-height:0px;text-align:` + ((e = u.textAlign) == null ? "" : e) + `">
  `, s(d) || (r += "<a " + ((e = p(d)) == null ? "" : e) + ">"), r += `
  <img alt="` + ((e = o) == null ? "" : e) + "\" class=\"" + ((e = i) == null ? "" : e) + "\" src=\"" + ((e = f) == null ? "" : e) + "\" style=\"" + ((e = a) == null ? "" : e) + "\" title=\"" + ((e = o) == null ? "" : e) + `"/>
  `, s(d) || (r += "</a>"), r += `
</div>
`;
	}
...
var er = {
	web(t, e, r, n, l, o, i, a) {
		let { columnIndex: s, columnValues: d, rowCells: p, rowValues: f, bodyValues: u } = a || {}, m = V(u), g = H({
			values: t,
			columnIndex: s,
			columnValues: d,
			rowCells: p,
			rowValues: f,
			bodyValues: u
		}), { imageCSSClassName: h, imageStyleObj: _, imageCSSStyle: b } = D(t.src, m ? g : 0), y = Ve(t?.src?.url, {
			dynamic: t?.src?.dynamic,
			resizeWidth: _?.maxWidth,
			originalWidth: t?.src?.width
		});
		return y ? Q0({
			values: t,
			imageCSSClassName: h,
			imageCSSStyle: b,
			linkAttrs: S(t.action),
			src: L(y),
			altText: L(t.altText),
			width: E(_.maxWidth)
		}) : "";
	...
	email(t, e, r, n, l, o, i, a) {
		let { columnIndex: s, columnValues: d, rowCells: p, rowValues: f, bodyValues: u } = a || {}, m = H({
			values: t,
			columnIndex: s,
			columnValues: d,
			rowCells: p,
			rowValues: f,
			bodyValues: u
		}), { imageCSSClassName: g, imageCSSStyle: h, imageStyleObj: _ } = D(t.src, m), b = S(t.action);
		delete b.onclick;
		let y = Ve(t?.src?.url, {
			dynamic: t?.src?.dynamic,
			resizeWidth: _?.maxWidth,
		...
		if (!y) return "";
		let v = E(_.maxWidth), w = t?.src?.width, x = t?.src?.height, q = v && w && x ? Math.round(v / w * x) : void 0;
		return Y0({
			imageCSSClassName: g,
			imageCSSStyle: h,
			linkAttrs: b,
	...
	ampWeb(t, e, r, n, l, o, i, a) {
		let { columnIndex: s, columnValues: d, rowCells: p, rowValues: f, bodyValues: u } = a || {}, m = V(u), g = H({
			...
			rowValues: f,
			bodyValues: u
		}), { imageCSSClassName: h, imageStyleObj: _ } = D(t.src, m ? g : 0), b = S(t.action);
		delete b.onclick;
		let y = Ve(t?.src?.url, {
			dynamic: t?.src?.dynamic,
			resizeWidth: _?.maxWidth,
	...
	ampEmail(t, e, r, n, l, o, i, a) {
		let { columnIndex: s, columnValues: d, rowCells: p, rowValues: f, bodyValues: u } = a || {}, m = H({
			...
			rowValues: f,
			bodyValues: u
		}), { imageCSSClassName: g, imageStyleObj: h } = D(t.src, m), _ = Ve(t?.src?.url, {
			dynamic: t?.src?.dynamic,
			resizeWidth: h?.maxWidth,
			originalWidth: t?.src?.width
		});
		return ev({
			imageCSSClassName: g,
	...
	classic(t) {
		let { imageCSSClassName: e, imageStyleObj: r, imageCSSStyle: n } = D(t.src);
		return tv({
			values: t,
			imageCSSClassName: e,
			imageCSSStyle: n,
...
var rv = function(t) {
	...
	var e, r = "";
	{
		let { htmlID: n, imageCSSStyle: l } = t || {};
		r += `
  #` + ((e = n) == null ? "" : e) + ` amp-img {
    display: inline-block;
    ` + ((e = l) == null ? "" : e) + `
...
var xs = { css(t, e, { columnIndex: r, columnValues: n, rowCells: l, rowValues: o, bodyValues: i, variant: a, isViewer: s }) {
	if (!s && a === "amp") {
		let d = V(i), p = H({
			values: t,
			columnIndex: r,
			...
			rowValues: o,
			bodyValues: i
		}), { imageCSSStyle: f } = D(t?.src, d ? p : 0);
		if (!f) return;
		let u = rv({
			htmlID: t._meta.htmlID,
			imageCSSStyle: f
		}).trim();
		return u ? ge(u) : void 0;
	}
} };
function vs(t) {
	return t != null;
...
function U(t) {
	return t ? Array.isArray(t) ? t.filter(vs) : [] : [];
}
var ws = (t) => {
	let { values: e, exporter: r } = t, { menu: { items: n }, fontFamily: l, fontSize: o, linkColor: i, align: a, separator: s, textColor: d, padding: p, layout: f, fontWeight: u, letterSpacing: m } = e, g = U(n);
	return g.length === 0 ? null : import_react.createElement("div", {
		style: {
			textAlign: a,
			letterSpacing: m
		},
		...
		let b = S(h.link);
		r && typeof b.onclick == "string" && (b["data-onclick-encoded"] = typeof globalThis < "u" && typeof globalThis.btoa == "function" ? globalThis.btoa(b.onclick) : Buffer.from(b.onclick, "utf8").toString("base64"), delete b.onclick);
		let y = [import_react.createElement("a", {
			...b,
			"aria-label": `Menu item - ${h?.text || _}`,
			key: `menu-item-${_}`,
			className: "v-padding v-font-size v-layout-display v-font-weight v-letter-spacing",
			style: {
		...
		return s && f !== "vertical" && _ + 1 < g.length && y.push(import_react.createElement("span", {
			"aria-label": "menu separator",
			className: "v-padding v-font-size v-letter-spacing hide-mobile",
			key: `menu-separator-${_}`,
			style: {
				display: "inline-block",
				padding: p,
				fontSize: o,
...
var ov = function(t) {
	...
	Array.prototype.join;
	{
		let { values: o } = t || {};
		r += `
<div aria-label="menu" class="menu" style="text-align:` + ((e = o.align) == null ? "" : e) + ";", o.letterSpacing && (r += "letter-spacing: " + ((e = o.letterSpacing) == null ? "" : e) + "; "), r += `">
<!--[if (mso)|(IE)]><table role="presentation" border="0" cellpadding="0" cellspacing="0" align="` + ((e = o.align) == null ? "" : e) + "\" style=\"", o.letterSpacing && (r += "letter-spacing: " + ((e = o.letterSpacing) == null ? "" : e) + "; "), r += `"><tr><![endif]-->
`, (o.items || []).forEach(function(i, a) {
			r += `
  <!--[if (mso)|(IE)]><td style="padding:` + ((e = o.padding) == null ? "" : e) + `"><![endif]-->
  `, A(i.linkAttrs) ? (r += `
  <span aria-label="` + ((e = i.ariaLabel) == null ? "" : e) + "\" style=\"padding:" + ((e = o.padding) == null ? "" : e) + ";display:" + ((e = o.display) == null ? "" : e) + ";color:" + ((e = o.textColor) == null ? "" : e) + ";", o.fontFamily && (r += "font-family:" + ((e = o.fontFamily) == null ? "" : e) + ";"), r += "font-size:" + ((e = o.fontSize) == null ? "" : e) + ";", o.fontWeight && (r += "font-weight: " + ((e = o.fontWeight) == null ? "" : e) + ";"), r += `" class="v-padding v-font-size v-layout-display v-font-weight v-letter-spacing">
    ` + ((e = i.text) == null ? "" : e) + `
  </span>
  `) : (r += `
    <a aria-label="` + ((e = i.ariaLabel) == null ? "" : e) + "\" " + ((e = T(i.linkAttrs)) == null ? "" : e) + " style=\"padding:" + ((e = o.padding) == null ? "" : e) + ";display:" + ((e = o.display) == null ? "" : e) + ";color:" + ((e = o.linkColor) == null ? "" : e) + ";", o.fontFamily && (r += "font-family:" + ((e = o.fontFamily) == null ? "" : e) + ";"), r += "font-size:" + ((e = o.fontSize) == null ? "" : e) + ";", o.fontWeight && (r += "font-weight: " + ((e = o.fontWeight) == null ? "" : e) + ";"), r += `text-decoration:none"  class="v-padding v-font-size v-layout-display v-font-weight v-letter-spacing">
      ` + ((e = i.text) == null ? "" : e) + `
    </a>
  `), r += `
  <!--[if (mso)|(IE)]></td><![endif]-->
  `, o.separator && o.layout != "vertical" && a + 1 < (o.items || []).length && (r += `
    <!--[if (mso)|(IE)]><td style="padding:` + ((e = o.padding) == null ? "" : e) + `"><![endif]-->
    <span aria-label="menu separator" style="padding:` + ((e = o.padding) == null ? "" : e) + ";display:" + ((e = o.display) == null ? "" : e) + ";color:" + ((e = o.textColor) == null ? "" : e) + ";", o.fontFamily && (r += "font-family:" + ((e = o.fontFamily) == null ? "" : e) + ";"), r += "font-size:" + ((e = o.fontSize) == null ? "" : e) + ";", o.fontWeight && (r += "font-weight: " + ((e = o.fontWeight) == null ? "" : e) + ";"), r += `" class="v-padding v-font-size hide-mobile v-font-weight v-letter-spacing">
      ` + ((e = o.separator) == null ? "" : e) + `
    </span>
    <!--[if (mso)|(IE)]></td><![endif]-->
  `), r += `
`;
...
var Cs = {
	web(t) {
		let e = {
			...
			menu: {
				...t?.menu,
				items: U(t?.menu?.items || [])
			}
		}, r = O(import_react.createElement(ws, {
			values: e,
			exporter: !0
		}));
		return r = r.replace(/data-onclick-encoded="([^\"]+)"/gi, (n, l) => `onclick="${typeof globalThis < "u" && typeof globalThis.atob == "function" ? globalThis.atob(l) : Buffer.from(l, "base64").toString("utf8")}"`), r;
	},
	email(t) {
		let { menu: { items: e = [] }, fontFamily: r, layout: n } = t, l = n == "horizontal" ? "inline-block" : "block", i = U(e).map((a, s) => {
			let d = S(a?.link);
			return delete d.onclick, {
				text: a?.text,
				linkAttrs: d,
				ariaLabel: `Menu item - ${a?.text || s}`
			};
		});
		return ov({ values: {
			...t,
...
function rr(t) {
	return t?.endsWith?.("%") ? `${parseFloat(t) / 100}` : t;
}
var iv = function(t) {
	t || (t = {});
	var e, r = "";
	Array.prototype.join;
	{
		let { lineHeight: o, text: i, values: a } = t || {};
		r += `
  <div class="v-color v-line-height v-font-weight v-font-family v-font-size v-letter-spacing v-text-align" style="`, a.fontFamily && (r += "font-family: " + ((e = a.fontFamily?.value) == null ? "" : e) + "; "), a.fontSize && (r += "font-size: " + ((e = a.fontSize) == null ? "" : e) + "; "), a.fontWeight && (r += "font-weight: " + ((e = a.fontWeight) == null ? "" : e) + "; "), a.color && (r += "color: " + ((e = a.color) == null ? "" : e) + "; "), a.letterSpacing && (r += "letter-spacing: " + ((e = a.letterSpacing) == null ? "" : e) + "; "), r += "line-height: " + ((e = o) == null ? "" : e) + ";  text-align: " + ((e = a.textAlign) == null ? "" : e) + `; word-wrap: break-word;">
    ` + ((e = i) == null ? "" : e) + `
  </div>
`;
	}
...
var av = function(t) {
	...
	Array.prototype.join;
	{
		let { lineHeight: o, text: i, textDirection: a, values: s } = t || {};
		r += `
  <div class="v-color v-line-height v-font-weight v-font-family v-font-size v-letter-spacing v-text-align" style="`, s.fontFamily && (r += "font-family: " + ((e = s.fontFamily?.value) == null ? "" : e) + "; "), s.fontSize && (r += "font-size: " + ((e = s.fontSize) == null ? "" : e) + "; "), s.fontWeight && (r += "font-weight: " + ((e = s.fontWeight) == null ? "" : e) + "; "), s.color && (r += "color: " + ((e = s.color) == null ? "" : e) + "; "), s.letterSpacing && (r += "letter-spacing: " + ((e = s.letterSpacing) == null ? "" : e) + "; "), r += "line-height: " + ((e = o) == null ? "" : e) + ";  text-align: " + ((e = s.textAlign) == null ? "" : e) + "; word-wrap: break-word;\"", a && (r += " dir=\"" + ((e = a) == null ? "" : e) + "\""), r += `>
    ` + ((e = i) == null ? "" : e) + `
  </div>
`;
	}
...
var nr = {
	web(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s } = a || {}, d = s?.generateHtmlFromTextJson?.(t.textJson) || "";
		return iv({
			values: t,
			text: W(s?.toSafeHtml ? s.toSafeHtml(d, { allowOnClick: !0 }) : d || ""),
			lineHeight: rr(t.lineHeight)
		});
	},
	email(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s } = a || {}, d = s?.generateHtmlFromTextJson?.(t.textJson) || "", p = W(s?.toSafeHtml ? s.toSafeHtml(d) : d || "");
		return av({
			values: t,
			text: p,
			textDirection: p.includes("dir=\"") ? void 0 : s?.textDirection,
...
var lv = function(t) {
	...
	Array.prototype.join;
	{
		let { htmlID: o, linkColor: i, linkUnderline: a } = t || {};
		r += `
  `, (i || a) && (r += `
  #` + ((e = o) == null ? "" : e) + ` a {
    `, i && (r += "color: " + ((e = i) == null ? "" : e) + ";"), r += `
    `, a && (r += "text-decoration: " + ((e = a) == null ? "" : e) + ";"), r += `
  }
  `), r += `
`;
	}
...
var sv = function(t) {
	...
	Array.prototype.join;
	{
		let { htmlID: o, linkHoverColor: i, linkHoverUnderline: a } = t || {};
		r += `
  `, (i || a) && (r += `
  #` + ((e = o) == null ? "" : e) + ` a:hover {
    `, i && (r += "color: " + ((e = i) == null ? "" : e) + ";"), r += `
...
var ks = { css(t, e, { displayMode: r }) {
	t.linkStyle = t.linkStyle || {};
	let { linkStyle: n } = t;
	if (n.inherit) return;
	let l = !n.inherit && n.linkColor && n.linkColor !== e.linkStyle.linkColor ? n.linkColor : void 0, o = !n.inherit && typeof n.linkUnderline == "boolean" && n.linkUnderline !== e.linkStyle.linkUnderline ? n.linkUnderline ? "underline" : "none" : void 0, i = !n.inherit && n.linkHoverColor && n.linkHoverColor !== (l || e.linkStyle.linkHoverColor) ? n.linkHoverColor : void 0, a = !n.inherit && typeof n.linkHoverUnderline == "boolean" && n.linkHoverUnderline !== n.linkUnderline ? n.linkHoverUnderline ? "underline" : "none" : void 0, s = [];
	return (l || o) && s.push(lv({
		htmlID: t._meta.htmlID,
		linkColor: l,
		linkUnderline: o
	}).trim()), r !== "email" && (i || a) && s.push(sv({
		htmlID: t._meta.htmlID,
		linkHoverColor: i,
		linkHoverUnderline: a
	}).trim()), s.filter(Boolean).join(`
`).trim() || void 0;
} };
function or({ icons: t, customIcons: e, iconType: r }) {
	return t.map((l) => {
		if (!l) return;
		let o = e?.find((i) => i && i.name === l.name);
		return {
			...l,
			imgUrl: o ? o.icons[r] : void 0
		};
	}).filter(Boolean);
}
function Ue(t) {
	return t?.name !== "Email" || t?.url?.includes("mailto") ? t?.url : `mailto:${t?.url}`;
}
function As(t) {
	let { icons: e, iconType: r, iconSize: n, align: l, spacing: o, cdnBaseUrl: i } = t;
	return e?.length ? import_react.createElement("div", {
		style: {
			textAlign: l,
			lineHeight: "0px",
			direction: "ltr"
		...
		if (!a) return null;
		let d = a?.imgUrl || `${i}/social/icons/${r}/${a.name.toLowerCase()}.png`;
		return import_react.createElement("a", {
			key: `icon-${s}`,
			href: Ue(a),
			target: "_blank",
			"aria-label": `${a.name} icon`,
			style: {
				display: "inline-block",
				width: `${n}px`,
				height: `${n}px`,
				marginRight: `${s == e.length - 1 ? 0 : o}px`
			}
		...
		src: `${i}/social/icons/default.png`,
		height: n,
		alt: "social icon"
	}));
}
var cv = function(t) {
	...
	Array.prototype.join;
	{
		let { align: o, cdnBaseUrl: i, iconSize: a, iconType: s, icons: d, maxWidth: p, spacing: f } = t || {};
		r += `
<div align="` + ((e = o) == null ? "" : e) + `" style="direction: ltr;" aria-label="social">
  <div style="display: table; max-width:` + ((e = p) == null ? "" : e) + `px;">
  <!--[if (mso)|(IE)]><table role="presentation" width="` + ((e = p) == null ? "" : e) + "\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"border-collapse:collapse;\" align=\"" + ((e = o) == null ? "" : e) + "\"><table role=\"presentation\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"border-collapse:collapse; mso-table-lspace: 0pt;mso-table-rspace: 0pt; width:" + ((e = p) == null ? "" : e) + `px;"><tr><![endif]-->
  
    `, (d || []).forEach(function(u, m) {
			r += `
    <!--[if (mso)|(IE)]><td width="` + ((e = a) == null ? "" : e) + "\" style=\"width:" + ((e = a) == null ? "" : e) + "px; padding-right: " + ((e = m == d.length - 1 ? 0 : f) == null ? "" : e) + `px;" valign="top"><![endif]-->
    <table role="presentation" aria-label="` + ((e = u.name) == null ? "" : e) + " icon\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"" + ((e = a) == null ? "" : e) + "\" height=\"" + ((e = a) == null ? "" : e) + "\" style=\"width: " + ((e = a) == null ? "" : e) + "px !important;height: " + ((e = a) == null ? "" : e) + "px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: " + ((e = m == d.length - 1 ? 0 : f) == null ? "" : e) + `px">
      <tbody><tr style="vertical-align: top"><td valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
        <a`, u.url && (r += " href=\"" + ((e = u.url) == null ? "" : e) + "\""), r += " title=\"" + ((e = u.name) == null ? "" : e) + `" target="_blank">
          <img src="`, u.imgUrl ? r += (e = u.imgUrl) == null ? "" : e : r += ((e = i) == null ? "" : e) + "/social/icons/" + ((e = s) == null ? "" : e) + "/" + ((e = (u.name || "").toLowerCase()) == null ? "" : e) + ".png", r += "\" alt=\"" + ((e = u.name) == null ? "" : e) + " icon\" title=\"" + ((e = u.name) == null ? "" : e) + "\" width=\"" + ((e = a) == null ? "" : e) + "\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: " + ((e = a) == null ? "" : e) + `px !important">
        </a>
      </td></tr>
    </tbody></table>
    <!--[if (mso)|(IE)]></td><![endif]-->
...
var dt = {
	web(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s } = a || {}, { icons: { editor: { data: d } = {}, iconType: p, icons: f } = {}, align: u, spacing: m, iconSize: g } = t, h = s?.cdnBaseUrl || "", _ = or({
			icons: U(f),
		...
		return O(import_react.createElement(As, {
			icons: _,
			iconType: p,
			iconSize: g,
			align: u,
	...
	email(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s } = a || {}, { icons: { editor: { data: d } = {}, iconType: p, icons: f } = {}, align: u, spacing: m, iconSize: g } = t, h = or({
			icons: U(f),
			customIcons: d?.customIcons,
			iconType: p
		}).map((y) => ({
		...
		return cv({
			...
			iconType: p,
			iconSize: g,
			maxWidth: g * h.length + m * (h.length - 1),
			align: u,
			spacing: m,
	...
	ampWeb(...t) {
		return dt.ampEmail(...t);
	}
};
var dv = (t) => (t ?? "").trim() === "" ? "​" : t;
var _e = (t, e) => typeof t.textJson == "string" && e ? W(e(t.textJson)) : W(dv(t.text || ""));
var Ts = function(t) {
	t || (t = {});
	var e, r = "";
	Array.prototype.join;
	{
		let { borderStyle: o, generateHtmlFromTextJson: i, mergeTagAfter: a, mergeTagBefore: s, tableStyle: d, values: p } = t || {};
		r += `
  <table class="v-background-color v-border-border" style="` + ((e = d) == null ? "" : e) + `">
    <colgroup>
      `, (p?.table?.headers?.[0]?.cells || p?.table?.rows?.[0]?.cells || []).forEach((f) => {
			r += `
      <col style="width: ` + ((e = f.width || 50) == null ? "" : e) + `%;" />
      `;
		}), r += `
    </colgroup>
    `, p?.enableHeader && (r += `
    <thead>
      `, p?.table?.headers?.forEach((f) => {
			r += `
      <tr`, f.height && (r += " style=\"height: " + ((e = f.height) == null ? "" : e) + "px;\""), r += `>
        `, f.cells.forEach((u) => {
				r += `
        <th`, (u.width || u.backgroundColor || u.color || u.textAlign || u.verticalAlign || u.padding || o) && (r += " style=\"" + ((e = o) == null ? "" : e), u.width && (r += " width: " + ((e = u.width) == null ? "" : e) + "%;"), u.backgroundColor && (r += " background-color: " + ((e = u.backgroundColor) == null ? "" : e) + ";"), u.color && (r += " color: " + ((e = u.color) == null ? "" : e) + ";"), u.textAlign && (r += " text-align: " + ((e = u.textAlign) == null ? "" : e) + ";"), u.verticalAlign && (r += " vertical-align: " + ((e = u.verticalAlign) == null ? "" : e) + ";"), u.padding && (r += " padding: " + ((e = u.padding) == null ? "" : e) + ";"), r += "\""), r += ">" + ((e = _e(u, i)) == null ? "" : e) + `</th>
        `;
			}), r += `
      </tr>
      `;
    ...
    `), r += `
    <tbody>
      `, p?.mergeTagGroup && p?.mergeTagRule && s && a ? (r += `
        ` + ((e = s) == null ? "" : e) + `
        `, p?.table?.rows?.forEach((f, u) => {
			r += `
        <tr`, p?.stripedRows && u % 2 === 0 && p?.stripedRowsBackgroundColor ? (r += " class=\"v-striped-rows-background-color-background-color\" style=\"background-color: " + ((e = p?.stripedRowsBackgroundColor) == null ? "" : e) + ";", f.height && (r += " height: " + ((e = f.height) == null ? "" : e) + "px;"), r += "\"") : f.height && (r += " style=\"height: " + ((e = f.height) == null ? "" : e) + "px;\""), r += `>
          `, f.cells.forEach((m) => {
				let g = p?.stripedRows && u % 2 === 0 && p?.stripedRowsBackgroundColor, h = m.backgroundColor || (g ? p?.stripedRowsBackgroundColor : null);
				r += `
          <td`, (m.width || h || m.color || m.textAlign || m.verticalAlign || m.padding || o) && (r += " style=\"" + ((e = o) == null ? "" : e), m.width && (r += " width: " + ((e = m.width) == null ? "" : e) + "%;"), h && (r += " background-color: " + ((e = h) == null ? "" : e) + ";"), m.color && (r += " color: " + ((e = m.color) == null ? "" : e) + ";"), m.textAlign && (r += " text-align: " + ((e = m.textAlign) == null ? "" : e) + ";"), m.verticalAlign && (r += " vertical-align: " + ((e = m.verticalAlign) == null ? "" : e) + ";"), m.padding && (r += " padding: " + ((e = m.padding) == null ? "" : e) + ";"), r += "\""), r += ">" + ((e = _e(m, i)) == null ? "" : e) + `</td>
          `;
			}), r += `
        </tr>
        `;
    ...
    `, p?.enableFooter && (r += `
    <tfoot>
      `, p?.table?.footers?.forEach((f) => {
			r += `
      <tr`, f.height && (r += " style=\"height: " + ((e = f.height) == null ? "" : e) + "px;\""), r += `>
        `, f.cells.forEach((u) => {
				r += `
        <td`, (u.width || u.backgroundColor || u.color || u.textAlign || u.verticalAlign || u.padding || o) && (r += " style=\"" + ((e = o) == null ? "" : e), u.width && (r += " width: " + ((e = u.width) == null ? "" : e) + "%;"), u.backgroundColor && (r += " background-color: " + ((e = u.backgroundColor) == null ? "" : e) + ";"), u.color && (r += " color: " + ((e = u.color) == null ? "" : e) + ";"), u.textAlign && (r += " text-align: " + ((e = u.textAlign) == null ? "" : e) + ";"), u.verticalAlign && (r += " vertical-align: " + ((e = u.verticalAlign) == null ? "" : e) + ";"), u.padding && (r += " padding: " + ((e = u.padding) == null ? "" : e) + ";"), r += "\""), r += ">" + ((e = _e(u, i)) == null ? "" : e) + `</td>
        `;
			}), r += `
      </tr>
      `;
...
var qs = (t) => {
	let e = "";
	t?.border && (e += be(t?.border));
	let r = `width: 100%; border-collapse: collapse; table-layout: fixed; ${e}`;
	return {
		borderStyle: e,
		tableStyle: r
	};
...
var ir = {
	web(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s, mergeTagState: d } = a || {}, { borderStyle: p, tableStyle: f } = qs(t), u = "", m = "";
		if (d) {
			let { mergeTagGroup: g, mergeTagRule: h, mergeTags: _ } = d, b = _?.[g]?.rules?.[h];
			b && (u = b.before, m = b.after);
		}
		return Ts({
			values: t,
			borderStyle: p,
			...
			mergeTagAfter: m,
			getCellContent: _e,
			generateHtmlFromTextJson: s?.generateHtmlFromTextJson
		});
	},
	email(t, e, r, n, l, o, i, a) {
		let { exporterConfig: s, mergeTagState: d } = a || {}, { borderStyle: p, tableStyle: f } = qs(t), u = "", m = "";
...
var mv = function(t) {
	...
	Array.prototype.join;
	{
		let { values: o } = t || {};
		r += `
  #` + ((e = o?._meta?.htmlID) == null ? "" : e) + ` table thead th {
    vertical-align: ` + ((e = o?.headerVerticalAlign) == null ? "" : e) + `;
    `, o?.headerPadding && (r += "padding: " + ((e = o?.headerPadding) == null ? "" : e) + ";"), r += `
    `, o?.headerFontFamily?.value && (r += "font-family: " + ((e = o?.headerFontFamily?.value) == null ? "" : e) + ";"), r += `
    `, o?.headerBackgroundColor && (r += "background-color: " + ((e = o?.headerBackgroundColor) == null ? "" : e) + ";"), r += `
    `, o?.headerFontSize && (r += "font-size: " + ((e = o?.headerFontSize) == null ? "" : e) + ";"), r += `
    `, o?.headerFontWeight && (r += "font-weight: " + ((e = o?.headerFontWeight) == null ? "" : e) + ";"), r += `
    `, o?.headerTextAlign && (r += "text-align: " + ((e = o?.headerTextAlign) == null ? "" : e) + ";"), r += `
    `, o?.headerColor && (r += "color: " + ((e = o?.headerColor) == null ? "" : e) + ";"), r += `
  }
`;
	}
	return r;
...
var gv = function(t) {
	...
	Array.prototype.join;
	{
		let { values: o } = t || {};
		r += `
  #` + ((e = o?._meta?.htmlID) == null ? "" : e) + ` table tfoot tr td {
    vertical-align: ` + ((e = o?.footerVerticalAlign) == null ? "" : e) + `;
    `, o?.footerPadding && (r += "padding: " + ((e = o?.footerPadding) == null ? "" : e) + ";"), r += `
    `, o?.footerFontFamily?.value && (r += "font-family: " + ((e = o?.footerFontFamily?.value) == null ? "" : e) + ";"), r += `
    `, o?.footerBackgroundColor && (r += "background-color: " + ((e = o?.footerBackgroundColor) == null ? "" : e) + ";"), r += `
    `, o?.footerFontSize && (r += "font-size: " + ((e = o?.footerFontSize) == null ? "" : e) + ";"), r += `
    `, o?.footerFontWeight && (r += "font-weight: " + ((e = o?.footerFontWeight) == null ? "" : e) + ";"), r += `
    `, o?.footerTextAlign && (r += "text-align: " + ((e = o?.footerTextAlign) == null ? "" : e) + ";"), r += `
    `, o?.footerColor && (r += "color: " + ((e = o?.footerColor) == null ? "" : e) + ";"), r += `
  }
`;
	}
	return r;
...
var hv = function(t) {
	...
	Array.prototype.join;
	{
		let { values: o } = t || {};
		r += `
  #` + ((e = o?._meta?.htmlID) == null ? "" : e) + ` table tbody td {
    vertical-align: ` + ((e = o?.contentVerticalAlign) == null ? "" : e) + `;
    `, o?.contentPadding && (r += "padding: " + ((e = o?.contentPadding) == null ? "" : e) + ";"), r += `
    `, o?.contentFontFamily?.value && (r += "font-family: " + ((e = o?.contentFontFamily?.value) == null ? "" : e) + ";"), r += `
    `, o?.contentBackgroundColor && (r += "background-color: " + ((e = o?.contentBackgroundColor) == null ? "" : e) + ";"), r += `
    `, o?.contentFontSize && (r += "font-size: " + ((e = o?.contentFontSize) == null ? "" : e) + ";"), r += `
    `, o?.contentFontWeight && (r += "font-weight: " + ((e = o?.contentFontWeight) == null ? "" : e) + ";"), r += `
    `, o?.contentTextAlign && (r += "text-align: " + ((e = o?.contentTextAlign) == null ? "" : e) + ";"), r += `
    `, o?.contentColor && (r += "color: " + ((e = o?.contentColor) == null ? "" : e) + ";"), r += `
    `, o?.contentLetterSpacing && (r += "letter-spacing: " + ((e = o?.contentLetterSpacing) == null ? "" : e) + ";"), r += `
    `, o?.contentLineHeight && (r += "line-height: " + ((e = o?.contentLineHeight) == null ? "" : e) + ";"), r += `
  }
`;
	}
	return r;
};
var Is = { css(t, e, { displayMode: r }) {
	let n = [];
	t?.enableHeader && (t?.headerPadding || t?.headerFontFamily?.value || t?.headerBackgroundColor || t?.headerFontSize || t?.headerFontWeight || t?.headerTextAlign || t?.headerColor) && n.push(mv({ values: t })), t?.enableFooter && (t?.footerPadding || t?.footerFontFamily?.value || t?.footerBackgroundColor || t?.footerFontSize || t?.footerFontWeight || t?.footerTextAlign || t?.footerColor) && n.push(gv({ values: t })), (t?.contentPadding || t?.contentFontFamily?.value || t?.contentBackgroundColor || t?.contentFontSize || t?.contentFontWeight || t?.contentTextAlign || t?.contentColor || t?.contentLetterSpacing || t?.contentLineHeight) && n.push(hv({ values: t }));
	let { linkStyle: o } = t;
	if (!o?.inherit) {
		let i = !!o?.linkColor && o?.linkColor !== e?.linkStyle?.linkColor, a = o?.linkUnderline !== null && o?.linkUnderline !== e?.linkStyle?.linkUnderline, s = i || a, d = !!o?.linkHoverColor && o?.linkHoverColor !== e?.linkStyle?.linkHoverColor, p = o?.linkHoverUnderline !== null && o?.linkHoverUnderline !== o?.linkUnderline, f = d || p;
		s && n.push(fv({
			values: t,
			linkColorChanged: i,
			linkUnderlineChanged: a
...
var Ps = { css(t, e, { displayMode: r }) {
	t.linkStyle = t.linkStyle || {};
	let { linkStyle: n } = t;
	if (n.inherit) return;
	let l = !n.inherit && n.linkColor && n.linkColor !== e.linkStyle.linkColor ? n.linkColor : void 0, o = !n.inherit && typeof n.linkUnderline == "boolean" && n.linkUnderline !== e.linkStyle.linkUnderline ? n.linkUnderline ? "underline" : "none" : void 0, i = !n.inherit && n.linkHoverColor && n.linkHoverColor !== (l || e.linkStyle.linkHoverColor) ? n.linkHoverColor : void 0, a = !n.inherit && typeof n.linkHoverUnderline == "boolean" && n.linkHoverUnderline !== n.linkUnderline ? n.linkHoverUnderline ? "underline" : "none" : void 0, s = [];
	return (l || o) && s.push(yv({
		htmlID: t._meta.htmlID,
		linkColor: l,
		linkUnderline: o
	}).trim()), r !== "email" && (i || a) && s.push(xv({
		htmlID: t._meta.htmlID,
		linkHoverColor: i,
		linkHoverUnderline: a
	}).trim()), s.filter(Boolean).join(`
...
function te(t, e) {
	return D({
		...t.width,
		autoWidth: t?.width?.autoWidth,
		maxWidth: t?.width?.width,
		width: t?.countdown?.width,
		height: t?.countdown?.height
	}, e, "width");
}
var Cv = function(t) {
	t || (t = {});
	...
	Array.prototype.join;
	{
		let { htmlID: o, imageCSSStyle: i } = t || {};
		r += `
  `, i && (r += `
  #` + ((e = o) == null ? "" : e) + ` amp-img {
    ` + ((e = i) == null ? "" : e) + `
...
var Ws = { css(t, e, { variant: r, isViewer: n }) {
	if (!n && r === "amp") {
		let { imageCSSStyle: l } = te(t);
		if (!l) return;
		let o = Cv({
			htmlID: t._meta.htmlID,
			imageCSSStyle: l
		}).trim();
		return o ? ge(o) : void 0;
	}
} };
var lr = 315 / 560;
function sr(t, e = "0px") {
	let { left: r, right: n } = $(e), l = parseInt(`${t || 0}`, 10) - (r || 0) - (n || 0);
	return {
		embedWidth: l,
		embedHeight: lr * l
	};
...
var kv = function(t) {
	...
	Array.prototype.join;
	{
		let { cdnBaseUrl: o, embedHeight: i, embedWidth: a, linkAttrs: s, video: d } = t || {};
		r += `
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px; padding-left: 0px;" align="center">
      `, A(s) || (r += "<a " + ((e = T(s)) == null ? "" : e) + ">"), r += `
      <img align="center" border="0" src="` + ((e = d.thumbnail || o + "/video/placeholder.png") == null ? "" : e) + "\" alt=\"Video\" title=\"Video\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: " + ((e = a) == null ? "" : e) + "px;\" width=\"" + ((e = a) == null ? "" : e) + "\" height=\"" + ((e = i) == null ? "" : e) + `" class="fullwidth" aria-label="video thumbnail" />
      `, A(s) || (r += "</a>"), r += `
    </td>
  </tr>
</table>
...
var Av = function(t) {
	...
	Array.prototype.join;
	{
		let { cdnBaseUrl: o, embedHeight: i, embedWidth: a, video: s, webAspectPadding: d } = t || {};
		r += `
<div style="position: relative; padding-bottom: ` + ((e = d) == null ? "" : e) + `%; height: 0; overflow: hidden; max-width: 100%;">
  `, (s.loading || !s.videoId) && (r += `
    <img
      aria-label="video placeholder"
      src="` + ((e = o) == null ? "" : e) + `/video/placeholder.png" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"
      width="` + ((e = a) == null ? "" : e) + `"
      height="` + ((e = i) == null ? "" : e) + `"
    />
  `), r += `  
  `, !s.loading && s.videoId && s.type == "youtube" && (r += `
    <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" width="` + ((e = a) == null ? "" : e) + "\" height=\"" + ((e = i) == null ? "" : e) + "\" src=\"https://www.youtube.com/embed/" + ((e = s.videoId) == null ? "" : e) + `" frameBorder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
  `), r += `
  `, !s.loading && s.videoId && s.type == "vimeo" && (r += `
    <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" width="` + ((e = a) == null ? "" : e) + "\" height=\"" + ((e = i) == null ? "" : e) + "\" src=\"https://player.vimeo.com/video/" + ((e = s.videoId) == null ? "" : e) + `" frameBorder="0" allowfullscreen></iframe>
  `), r += `
</div>
`;
	}
...
var Fs = { _email: (t, e, r, n, l, o, i, a) => {
	let { bodyValues: s, columnIndex: d, columnValues: p, exporterConfig: f, rowCells: u, rowValues: m } = a || {}, g = H({
		values: t,
		columnIndex: d,
		columnValues: p,
		rowCells: u,
		rowValues: m,
		bodyValues: s
	}), h = f?.cdnBaseUrl || "", { embedWidth: _, embedHeight: b } = sr(g), y = S(t.href);
	return kv({
		cdnBaseUrl: h,
		embedWidth: _,
		embedHeight: b,
...
var ur = {
	web(t, e, r, n, l, o, i, a) {
		let { bodyValues: s, columnIndex: d, columnValues: p, exporterConfig: f, rowCells: u, rowValues: m } = a || {}, g = H({
			...
			rowValues: m,
			bodyValues: s
		}), h = f?.cdnBaseUrl || "", { embedWidth: _, embedHeight: b } = sr(g);
		return Av({
			cdnBaseUrl: h,
			embedHeight: b,
			embedWidth: _,
	...
	email(...t) {
		return Fs._email(...t).replace(/\s+height="[\d.]+"/g, "");
	},
	ampWeb(...t) {
		return ur.web(...t).replace(/<iframe(\s)/g, "<amp-iframe sandbox=\"allow-scripts allow-same-origin\" layout=\"responsive\"$1").replace(/<\/iframe>/g, "</amp-iframe>").replace(/<img(\s)/g, "<amp-img layout=\"responsive\"$1");
	},
	ampEmail(...t) {
		return Fs._email(...t).replace(/(<img\s+)align="center"\s+border="0"\s*/g, "$1").replace(/<img(\s)/g, "<amp-img layout=\"responsive\"$1");
	}
};
var Os = { tags(t, e, { displayMode: r, isViewer: n, variant: l }) {
	let o = [];
	return l === "amp" && r === "web" && !n && o.push("<script async custom-element=\"amp-iframe\" src=\"https://cdn.ampproject.org/v0/amp-iframe-0.1.js\"><\/script>"), o;
} };
var Ds = I(P());
var Tv = !0;
function Bs(t) {
...
function qv(t) {
	...
	switch (e) {
		...
		case "bottom-left":
		case "bottom-center":
		case "bottom-right": return e.split("-").reverse().join(" ");
		case "center": return "center center";
		default: return "auto auto";
	}
}
function re(t, { displayMode: e }) {
	if (e === "email" && !Tv) return;
	let { position: r, customPosition: n } = t || {};
	if (r !== "custom") return qv(r);
	if (r === "custom" && (0, Ds.default)(n)) return n.map((l) => l ?? "auto").join(" ");
}
function $s(t) {
	switch (t) {
		case "top":
		...
		case "top-center":
		case "center-top": return "top-center";
		case "top-right":
		case "right":
		...
		case "bottom-center":
		case "center-bottom": return "bottom-center";
		case "bottom-right":
		case "right-bottom": return "bottom-right";
		default: return;
	}
}
var Iv = function(t) {
	...
	Array.prototype.join;
	{
		let { innerHTML: o, style: i, values: a } = t || {};
		r += `
  <div id="` + ((e = a._meta.htmlID) == null ? "" : e) + "\" class=\"" + ((e = a._meta.htmlClassNames) == null ? "" : e) + "\"", i && (r += " style=\"" + ((e = i) == null ? "" : e) + "\""), r += `>
    ` + ((e = o) == null ? "" : e) + `
  </div>
`;
	}
...
var Pv = function(t) {
	...
	Array.prototype.join;
	{
		let { innerHTML: o, style: i, type: a, values: s } = t || {};
		r += `
  <body id="` + ((e = s._meta.htmlID) == null ? "" : e) + "\" class=\"" + ((e = s._meta.htmlClassNames) == null ? "" : e) + `">
    <div class="` + ((e = s._meta.htmlClassNames) == null ? "" : e) + " content" + ((e = a === "headers" ? "-header" : a === "footers" ? "-footer" : "") == null ? "" : e) + "\"", i && (r += " style=\"" + ((e = i) == null ? "" : e) + "\""), r += `>
      ` + ((e = o) == null ? "" : e) + `
      
      `, a !== "footers" && a !== "headers" && (r += `
...
var Hv = function(t) {
	...
	Array.prototype.join;
	{
		let { bgcolor: o, contentAlign: i, contentWidthNumber: a, innerHTML: s, preheaderText: d, style: p, values: f } = t || {};
		r += `
<body class="clean-body ` + ((e = f._meta.htmlClassNames) == null ? "" : e) + "\" style=\"" + ((e = p) == null ? "" : e) + `">
  <!--[if IE]><div class="ie-container"><![endif]-->
  <!--[if mso]><div class="mso-container"><![endif]-->
  <table role="presentation" id="` + ((e = f._meta.htmlID) == null ? "" : e) + "\" style=\"border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: " + ((e = f.backgroundColor || "transparent") == null ? "" : e) + `;width:100%" cellpadding="0" cellspacing="0">
  <tbody>`, d && (r += `
  <tr>
  ...
  <tr style="vertical-align: top">
    ...
    <!--[if (mso)|(IE)]><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="` + ((e = i) == null ? "" : e) + "\" style=\"background-color: " + ((e = o || "transparent") == null ? "" : e) + ";\"", o && (r += " bgcolor=\"" + ((e = o) == null ? "" : e) + "\""), r += "><table role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"" + ((e = a) == null ? "" : e) + "\" align=\"" + ((e = i) == null ? "" : e) + `" style="border-collapse: collapse;"><tr><td style="padding:0;"><![endif]-->
    ` + ((e = s) == null ? "" : e) + `
...
var Ev = function(t) {
	...
	Array.prototype.join;
	{
		let { closeButton: o, innerHTML: i, style: a, values: s } = t || {};
		r += `
<div class="u-popup-main">
  `, o.html && o.placement === "header" && (r += `
  ...
  <div class="u-popup-content">
    <div
      id="` + ((e = s._meta.htmlID) == null ? "" : e) + `"
      class="` + ((e = s._meta.htmlClassNames) == null ? "" : e) + `"
      style="` + ((e = a) == null ? "" : e) + `">
      ` + ((e = i) == null ? "" : e) + `
    </div>
  </div>

  `, o.html && o.placement === "footer" && (r += `
...
var Ls = {
	web(t, e) {
		return Iv({
			innerHTML: t,
			values: e,
			style: "min-height: 100vh; display: flex; flex-direction: column;".trim()
		});
	},
	email(t, e, { bodyValues: r }) {
		let { backgroundColor: n, textColor: l } = e, o = j(n), i = r?.contentAlign || "center", a = parseFloat(`${r?.contentWidth || 600}`), s = "margin: 0;padding: 0;-webkit-text-size-adjust: 100%;";
		return n && (s += `background-color: ${n};`), l && (s += `color: ${l}`), Hv({
			innerHTML: t,
			values: e,
			bgcolor: o,
			contentAlign: i,
			contentWidthNumber: a,
			preheaderText: e.preheaderText,
			style: s.trim()
		});
	},
	popup(t, e) {
		let { borderRadius: r, contentVerticalAlign: n, fontFamily: l, popupBackgroundColor: o, popupBackgroundImage: i, popupCloseButton_action: a, popupCloseButton_position: s, popupHeight: d, textColor: p, fontWeight: f } = e, u = "";
		if (n) switch (u += " display: flex;", u += " flex-direction: column;", n) {
			case "top":
		...
		d !== "auto" && (u += " min-height: 100%;".trim()), p && (u += ` color: ${p};`.trim()), o && (u += ` background-color: ${o};`.trim()), l && (u += ` font-family: ${l?.value};`.trim()), f && (u += ` font-weight: ${f};`.trim());
		let m = `${i?.url || ""}`.trim().replace(/ /g, "%20");
		if (m) {
			u += ` background-image: url('${m}');`, u += ` background-repeat: ${i?.repeat || "no-repeat"};`.trim();
			let _ = re(i, { displayMode: "popup" });
			_ && (u += ` background-position: ${_};`.trim());
			let b = ee(i, { displayMode: "popup" });
			b && (u += ` background-size: ${b};`.trim());
		}
		r && (u += ` border-radius: ${r};`);
		return Ev({
			closeButton: {
				html: Wv({ values: { linkAttrs: ql(a) } }),
				placement: s?.startsWith("bottom") ? "footer" : "header"
			},
			innerHTML: t,
			style: u.trim(),
			values: e
	...
	document(t, e, { type: r }) {
		return Pv({
			...
			values: e,
			type: r,
			style: `${r !== "headers" && r !== "footers" ? "min-height: 100vh;" : ""}`
		});
	}
};
var Wv = function(t) {
	...
	var e, r = "";
	{
		let { values: n } = t || {};
		r += `
  <a ` + ((e = T(n.linkAttrs)) == null ? "" : e) + ` class="u-close-button">
...
var Fv = function(t) {
	...
	Array.prototype.join;
	{
		let { backgroundColor: o, backgroundImage: i, backgroundPosition: a, backgroundSize: s, closeButton: d, containerStyle: p, displayMode: f, fontFamily: u, fontSize: m, lineHeight: g, linkColor: h, linkHoverColor: _, linkHoverUnderline: b, linkUnderline: y, popupMargin: v, textColor: w, type: x, values: q } = t || {};
		r += `
  `, f === "web" && (r += `
  body {
    font-family: ` + ((e = u?.value || "Arial, Helvetica, sans-serif") == null ? "" : e) + `;
    font-size: ` + ((e = m || "1rem") == null ? "" : e) + `;
    line-height: ` + ((e = g || "1.5") == null ? "" : e) + `;
    color: ` + ((e = w || "#000000") == null ? "" : e) + `;
    background-color: ` + ((e = o || "#fff") == null ? "" : e) + `;
    `, q.fontWeight && (r += "font-weight: " + ((e = q.fontWeight) == null ? "" : e) + "; "), r += `
    `, i?.url && (r += `
      background-image: url('` + ((e = i.url) == null ? "" : e) + `');
      background-repeat: ` + ((e = i.repeat || "no-repeat") == null ? "" : e) + `;
      `, a && (r += "background-position: " + ((e = a) == null ? "" : e) + ";"), r += `
      `, s && (r += "background-size: " + ((e = s) == null ? "" : e) + ";"), r += `
    `), r += `
  }
  `), r += `

  `, f === "document" && (r += `
    .content`, x && x !== "" && (r += "-" + ((e = x) == null ? "" : e)), r += ` {
      width: 100%;
      font-family: ` + ((e = u?.value || "Arial, Helvetica, sans-serif") == null ? "" : e) + `;
      font-size: 15px;
      color: ` + ((e = w || "#000000") == null ? "" : e) + `;
      `, i?.url ? (r += `
        background-image: url('` + ((e = i?.url) == null ? "" : e) + `');
        background-repeat: ` + ((e = i?.repeat ? "repeat" : "no-repeat") == null ? "" : e) + `;
        background-position: ` + ((e = i?.center ? "center top" : "left top") == null ? "" : e) + `;
        `, i?.cover && (r += "background-size: cover;"), r += `
      `) : r += `
        background-color: ` + ((e = o || "#fff") == null ? "" : e) + `;
      `, r += `
  ...
  .u-popup-container a {
  ` : r += `
  #` + ((e = q._meta.htmlID) == null ? "" : e) + ` a {
  `, r += `
    `, h && (r += "color: " + ((e = h) == null ? "" : e) + ";"), r += `
    text-decoration: ` + ((e = y ? "underline" : "none") == null ? "" : e) + `;
  }
  `, f !== "email" && (r += `
  #` + ((e = q._meta.htmlID) == null ? "" : e) + ` a:hover {
    `, _ && (r += "color: " + ((e = _) == null ? "" : e) + ";"), r += `
    text-decoration: ` + ((e = b ? "underline" : "none") == null ? "" : e) + `;
  }
  `), r += `
  `, f === "popup" && (r += `
  .u-popup-container {
  ...
  .u-popup-container .u-popup-overlay {
    ...
    bottom: 0;
    top: 0;
    background-color: ` + ((e = q.popupOverlay_backgroundColor) == null ? "" : e) + `;
    z-index: 98;
  }

  .u-popup-container .u-popup-main {
    width: 100%;
    max-width: ` + ((e = q.popupWidth || "80%") == null ? "" : e) + `;
    height: ` + ((e = q.popupHeight || "80%") == null ? "" : e) + `;
    margin: ` + ((e = v) == null ? "" : e) + `;
    z-index: 99;
  }
  ...
  .u-popup-container .u-popup-content {
    height: 100%;
    overflow-y: ` + ((e = q.popupHeight === "auto" ? "inherit" : "auto") == null ? "" : e) + `;
  }

  `, typeof d < "u" && d && (r += `
  .u-popup-container .u-close-button {
    position: absolute;
    `, d.position === "top-left" ? r += `
    top: 0px;
    left: 0px;
    ` : d.position === "bottom-left" ? r += `
    bottom: 0px;
    left: 0px;
    ` : d.position === "bottom-right" ? r += `
    bottom: 0px;
    right: 0px;
    ` : r += `
    top: 0px;
    ...
    align-items: center;
    margin: ` + ((e = d.margin || "0px") == null ? "" : e) + `;
    padding: 0px;
    width: 40px;
    height: 40px;
    background-color: ` + ((e = d.backgroundColor) == null ? "" : e) + `;
    border: 0;
    border-radius: ` + ((e = d.borderRadius || "0px") == null ? "" : e) + `;
    cursor: pointer;
    z-index: 99;
  }
  ...
  .u-popup-container .u-close-button .icon-cross:after {
    ...
    right: 0;
    height: 3px;
    background-color: ` + ((e = d.iconColor) == null ? "" : e) + `;
    border-radius: 6px;
  }
...
var Rs = {
	css(t, e, { displayMode: r, type: n, isViewer: l, headConfig: o }) {
		let i = o?.getInitialValues?.("bodies") || {}, { backgroundColor: a, backgroundImage: s, fontFamily: d, fontSize: p, lineHeight: f, popupCloseButton_backgroundColor: u, popupCloseButton_borderRadius: m, popupCloseButton_iconColor: g, popupCloseButton_margin: h, popupCloseButton_position: _, textColor: b, popupDisplayDelay: y } = t, v = "", w = {
			...i.linkStyle,
			...t.linkStyle || {}
		};
		w.linkColor = w.linkColor || void 0, w.linkUnderline = w.linkUnderline || void 0, w.linkHoverColor = w.linkHoverColor || void 0, w.linkHoverUnderline = w.linkHoverUnderline || void 0;
		let x = n === "headers" ? "header" : n === "footers" ? "footer" : "";
		return !l && y > 0 && (v += `
        .u-popup-container {
          display: none;
        }
      `), Fv({
			...
			backgroundColor: a,
			backgroundImage: s,
			backgroundPosition: re(s, { displayMode: r }),
			backgroundSize: ee(s, { displayMode: r }),
			fontFamily: d || {},
			fontSize: p,
			lineHeight: f,
			textColor: b,
			popupMargin: Bs(t.popupPosition).join(" "),
			...w,
			closeButton: {
				backgroundColor: u,
				borderRadius: m,
	...
	tags({ popupDisplayDelay: t = 0 }, e, { isViewer: r, variant: n }) {
		let l = [];
		return n === "amp" && !r && l.push("<script async src=\"https://cdn.ampproject.org/v0.js\"><\/script>"), n === "amp" && r && l.push("<script async src=\"https://cdn.ampproject.org/v0/validator_wasm.js\"><\/script>"), !r && t > 0 && l.push(`
        <script>
          setTimeout(() => {
...
function cr(t = {}, { important: e = !1 } = {}) {
	let { borderTopWidth: r, borderTopStyle: n, borderTopColor: l, borderLeftWidth: o, borderLeftStyle: i, borderLeftColor: a, borderRightWidth: s, borderRightStyle: d, borderRightColor: p, borderBottomWidth: f, borderBottomStyle: u, borderBottomColor: m } = t, g = parseInt(r || "0px") > 0, h = parseInt(o || "0px") > 0, _ = parseInt(s || "0px") > 0, b = parseInt(f || "0px") > 0, y = e ? " !important" : "", v = "";
	return v += `border-top: ${r || "0px"} ${n || "solid"} ${g && l || "transparent"}${y};`, v += `border-left: ${o || "0px"} ${i || "solid"} ${h && a || "transparent"}${y};`, v += `border-right: ${s || "0px"} ${d || "solid"} ${_ && p || "transparent"}${y};`, v += `border-bottom: ${f || "0px"} ${u || "solid"} ${b && m || "transparent"}${y};`, v;
}
I(Us());
I(K());
I(xc());
...
function wr({ rowSpan: t, colSpan: e }) {
	let r = zc(e / t * 100);
	return {
		value: r,
		className: jk(r)
...
var Vk = function(t) {
	...
	Array.prototype.join;
	{
		let { border: o, borderRadius: i, colClass: a, innerHTML: s, padding: d, rowValues: p, values: f } = t || {};
		r += `
<div id="` + ((e = f._meta.htmlID) == null ? "" : e) + "\" class=\"" + ((e = a) == null ? "" : e) + " " + ((e = f._meta.htmlClassNames) == null ? "" : e) + " v-row-align-items v-col-background-color v-col-border v-col-border-radius\" style=\"display:flex;", p.alignItems && (r += "align-items:" + ((e = p.alignItems) == null ? "" : e) + ";"), f.backgroundColor && (r += "background-color:" + ((e = f.backgroundColor) == null ? "" : e) + ";"), o && (r += (e = o) == null ? "" : e), i && (r += (e = i) == null ? "" : e), r += `">
  <div class="v-col-padding" style="width: 100%;padding:` + ((e = d) == null ? "" : e) + `;">
    ` + ((e = s) == null ? "" : e) + `
  </div>
</div>
`;
...
var Uk = function(t) {
	...
	Array.prototype.join;
	{
		let { border: o, borderRadius: i, innerHTML: a, padding: s, tableWidth: d, values: p, width: f, widthPercent: u } = t || {};
		r += `
<!--[if (mso)|(IE)]><td align="center" width="` + ((e = d) == null ? "" : e) + "\" class=\"v-col-background-color v-col-border v-col-border-radius\" style=\"", p.backgroundColor && (r += "background-color: " + ((e = p.backgroundColor) == null ? "" : e) + ";"), r += "width: " + ((e = d) == null ? "" : e) + "px;", o && (r += (e = o) == null ? "" : e), i && (r += (e = i) == null ? "" : e), r += "\" valign=\"top\"><table role=\"presentation\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td class=\"v-col-padding\" style=\"padding: " + ((e = s) == null ? "" : e) + `;"><![endif]-->
<div id="` + ((e = p._meta.htmlID) == null ? "" : e) + "\" class=\"u-col u-col-" + ((e = u) == null ? "" : e) + " " + ((e = p._meta.htmlClassNames) == null ? "" : e) + "\" style=\"max-width: 320px;min-width: " + ((e = f) == null ? "" : e) + `px;display: table-cell;vertical-align: top;">
  <div class="v-col-background-color v-col-border-radius" style="`, p.backgroundColor && (r += "background-color: " + ((e = p.backgroundColor) == null ? "" : e) + ";"), r += "height: 100%;width: 100% !important;", i && (r += (e = i) == null ? "" : e), r += `">
  <!--[if (!mso)&(!IE)]><!--><div class="v-col-padding v-col-border v-col-border-radius" style="box-sizing: border-box; height: 100%; padding: ` + ((e = s) == null ? "" : e) + ";", o && (r += (e = o) == null ? "" : e), i && (r += (e = i) == null ? "" : e), r += `"><!--<![endif]-->
  ` + ((e = a) == null ? "" : e) + `
  <!--[if (!mso)&(!IE)]><!--></div><!--<![endif]-->
  </div>
</div>
...
var Ne = {
	web(t, e, r, n, l, o) {
		let i = n.reduce((m, g) => m + g, 0), a = n[r], d = `u-col u-col-${wr({
			rowSpan: i,
			colSpan: a
		}).className}`, p = cr(e.border), f = e.borderRadius && `border-radius: ${e.borderRadius};`;
		return Vk({
			innerHTML: t,
			values: e,
			rowValues: o,
			colClass: d,
			border: p,
			padding: e.padding || "0px",
			borderRadius: f
		});
	},
	email(t, e, r, n, l, o) {
		let i = n.reduce((b, y) => b + y, 0), a = n[r], s = parseFloat(`${l.contentWidth || 0}`), d = a / i * s, p = wr({
			rowSpan: i,
			colSpan: a
		}).className, f = cr(e.border), u = e.border && e.border.borderLeftWidth ? parseInt(e.border.borderLeftWidth) : 0, m = e.border && e.border.borderRightWidth ? parseInt(e.border.borderRightWidth) : 0, g = Math.floor(d - u - m), h = e.padding || "0px", _ = e.borderRadius && `border-radius: ${e.borderRadius};` + Ze(e.borderRadius);
		return Uk({
			innerHTML: t,
			values: e,
			width: E(d, 2),
...
var jc = {};
function gt(t, { amp: e = !1, defaultDevice: r = "desktop" } = {}) {
	if (e) return !1;
	let n = t?._override?.desktop || {}, l = t?._override?.tablet || {}, o = t?._override?.mobile || {};
	switch (r) {
		case "desktop": return !!n.hideDesktop;
		case "tablet": return !!l.hideTablet;
		case "mobile": return !!o.hideMobile;
		default: return !1;
	}
}
function ne(t, e) {
	return t && !e ? `<a name="${t}"></a>` : "";
}
var Mk = function(t) {
	t || (t = {});
	var e, r = "";
	Array.prototype.join;
	{
		let { anchor: o, desktop: i, innerHTML: a, mobile: s, tablet: d, values: p } = t || {};
		r += ((e = o) == null ? "" : e) + `
  <div id="` + ((e = p._meta.htmlID) == null ? "" : e) + "\" class=\"" + ((e = p._meta.htmlClassNames) == null ? "" : e) + " v-container-padding-padding", i.hideDesktop && (r += " hide-desktop"), d.hideTablet && (r += " hide-tablet"), s.hideMobile && (r += " hide-mobile"), r += "\" style=\"overflow-wrap: break-word;padding: " + ((e = p.containerPadding) == null ? "" : e) + `;">
    ` + ((e = a) == null ? "" : e) + `
  </div>
`;
	}
...
var Nk = function(t) {
	...
	Array.prototype.join;
	{
		let { anchor: o, innerHTML: i, values: a } = t || {};
		r += ((e = o) == null ? "" : e) + `
  <div id="` + ((e = a._meta.htmlID) == null ? "" : e) + "\" class=\"" + ((e = a._meta.htmlClassNames) == null ? "" : e) + " v-container-padding\" style=\"overflow-wrap: break-word;", a.containerPadding && (r += "padding: " + ((e = a.containerPadding) == null ? "" : e) + ";"), r += `">
    ` + ((e = i) == null ? "" : e) + `
  </div>
`;
	}
...
var Gk = function(t) {
	...
	Array.prototype.join;
	{
		let { anchor: o, bodyValues: i, desktop: a, innerHTML: s, mobile: d, shouldHideByDefault: p, tablet: f, values: u } = t || {};
		o && (r += ((e = o) == null ? "" : e) + `
`), p && (r += "<!--[if !mso]><!-->"), r += `
<table id="` + ((e = u._meta.htmlID) == null ? "" : e) + "\" class=\"" + ((e = u._meta.htmlClassNames) == null ? "" : e), p && (r += " hide-default__display-table"), a.hideDesktop && (r += " hide-desktop"), f.hideTablet && (r += " hide-tablet"), d.hideMobile && (r += " hide-mobile"), r += "\" style=\"", p && (r += "display: none;mso-hide: all;"), r += "font-family:" + ((e = i.fontFamily?.value) == null ? "" : e) + `;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:` + ((e = u.containerPadding) == null ? "" : e) + ";font-family:" + ((e = i.fontFamily?.value) == null ? "" : e) + `;" align="left">
        ` + ((e = s) == null ? "" : e) + `
      </td>
    </tr>
  </tbody>
...
var Vc = {
	web(t, e, r, { variant: n }) {
		return Mk({
			innerHTML: t,
			values: e,
			anchor: ne(e?.anchor, n === "amp"),
			desktop: e?._override?.desktop || {},
			tablet: e?._override?.tablet || {},
			mobile: e?._override?.mobile || {}
		});
	},
	email(t, e, r, n) {
		let { defaultDevice: l, variant: o } = n;
		return Gk({
			innerHTML: t,
			values: e,
			bodyValues: r,
			anchor: ne(e?.anchor, o === "amp"),
			shouldHideByDefault: gt(e, {
				amp: o === "amp",
				defaultDevice: l
			}),
			desktop: e?._override?.desktop || {},
...
var Jk = function(t) {
	...
	Array.prototype.join;
	{
		let { anchor: o, containerStyle: i, desktop: a, innerContainerStyle: s, innerHTML: d, mobile: p, rowStyle: f, tablet: u, values: m, wrapperTag: g } = t || {};
		r += ((e = o) == null ? "" : e) + `
  <` + ((e = g) == null ? "" : e) + " id=\"" + ((e = m._meta.htmlID) == null ? "" : e) + "\" class=\"" + ((e = m._meta.htmlClassNames) == null ? "" : e) + " v-row-padding v-row-background-image--outer v-row-background-color", a.hideDesktop && (r += " hide-desktop"), u.hideTablet && (r += " hide-tablet"), p.hideMobile && (r += " hide-mobile"), r += "\" style=\"" + ((e = i) == null ? "" : e) + `">
    <div class="container v-row-background-image--inner v-row-columns-background-color-background-color" style="` + ((e = s) == null ? "" : e) + `">
      <div class="u-row`, p.noStackMobile && (r += " no-stack"), r += " v-row-align-items\"", f && (r += " style=\"" + ((e = f) == null ? "" : e) + "\""), r += `>
        ` + ((e = d) == null ? "" : e) + `
      </div>
    </div>
  </` + ((e = g) == null ? "" : e) + `>
...
var Kk = function(t) {
	...
	Array.prototype.join;
	{
		let { anchor: o, backgroundImageRepeat: i, backgroundPosition: a, backgroundSize: s, bgcolor: d, columnsBgcolor: p, contentWidthNumber: f, contentWidthWithUnit: u, desktop: m, hasBackgroundImageURL: g, innerHTML: h, margin: _, mobile: b, padding: y, shouldHideByDefault: v, tablet: w, values: x, wrapperTag: q } = t || {};
		r += ((e = o) == null ? "" : e) + `
`, v && (r += "<!--[if !mso]><!-->"), r += `
`, g && (r += `
<!--[if gte mso 9]>
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="` + ((e = f) == null ? "" : e) + "\"", d && (r += " bgcolor=\"" + ((e = d) == null ? "" : e) + "\""), r += `>
  <tr>
    <td background="` + ((e = x.backgroundImage.url) == null ? "" : e) + `" valign="top">
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:` + ((e = u) == null ? "" : e) + `;">
        <v:fill type="` + ((e = i ? "tile" : "frame") == null ? "" : e) + "\" src=\"" + ((e = x.backgroundImage.url) == null ? "" : e) + `" />
        <v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
<![endif]-->
`), r += `
<` + ((e = q) == null ? "" : e) + " id=\"" + ((e = x._meta.htmlID) == null ? "" : e) + "\" class=\"u-row-container " + ((e = x._meta.htmlClassNames) == null ? "" : e) + " v-row-padding--vertical v-row-background-image--outer v-row-background-color", v && (r += " hide-default__display-block"), m.hideDesktop && (r += " hide-desktop"), w.hideTablet && (r += " hide-tablet"), b.hideMobile && (r += " hide-mobile"), r += "\" style=\"", v && (r += "display: none;mso-hide: all;"), y && (r += "padding: " + ((e = y) == null ? "" : e) + ";"), g && x.backgroundImage.fullWidth && (r += "background-image: url('" + ((e = x.backgroundImage.url) == null ? "" : e) + "');background-repeat: " + ((e = x.backgroundImage.repeat || "no-repeat") == null ? "" : e) + ";", a && (r += "background-position: " + ((e = a) == null ? "" : e) + ";")), s && (r += "background-size: " + ((e = s) == null ? "" : e) + ";"), r += "background-color: " + ((e = d || "transparent") == null ? "" : e) + `;">
  <div class="u-row v-row-columns-background-color-background-color`, b.noStackMobile && (r += " no-stack"), r += "\" style=\"margin: " + ((e = _) == null ? "" : e) + ";min-width: 320px;max-width: " + ((e = u) == null ? "" : e) + ";overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: " + ((e = p || "transparent") == null ? "" : e) + `;">
    <div class="v-row-background-image--inner" style="border-collapse: collapse;display: table;width: 100%;height: 100%;`, g && !x.backgroundImage.fullWidth && (r += "background-image: url('" + ((e = x.backgroundImage.url) == null ? "" : e) + "');background-repeat: " + ((e = x.backgroundImage.repeat || "no-repeat") == null ? "" : e) + ";", a && (r += "background-position: " + ((e = a) == null ? "" : e) + ";")), s && (r += "background-size: " + ((e = s) == null ? "" : e) + ";"), r += `background-color: transparent;">
      <!--[if (mso)|(IE)]><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td class="v-row-padding v-row-background-image--outer v-row-background-color" style="`, y && (r += "padding: " + ((e = y) == null ? "" : e) + ";"), g && x.backgroundImage.fullWidth && (r += "background-image: url('" + ((e = x.backgroundImage.url) == null ? "" : e) + "');background-repeat: " + ((e = x.backgroundImage.repeat || "no-repeat") == null ? "" : e) + ";", a && (r += "background-position: " + ((e = a) == null ? "" : e) + ";")), s && (r += "background-size: " + ((e = s) == null ? "" : e) + ";"), r += "background-color: " + ((e = d || "transparent") == null ? "" : e) + ";\"><table role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\"", p && (r += " bgcolor=\"" + ((e = p) == null ? "" : e) + "\""), r += "><tr class=\"v-row-background-image--inner v-row-columns-background-color-background-color\" style=\"", g && !x.backgroundImage.fullWidth && (r += "background-image: url('" + ((e = x.backgroundImage.url) == null ? "" : e) + "');background-repeat: " + ((e = x.backgroundImage.repeat || "no-repeat") == null ? "" : e) + ";", a && (r += "background-position: " + ((e = a) == null ? "" : e) + ";")), s && (r += "background-size: " + ((e = s) == null ? "" : e) + ";"), r += "background-color: " + ((e = p || "transparent") == null ? "" : e) + `;"><![endif]-->
      ` + ((e = h) == null ? "" : e) + `
      <!--[if (mso)|(IE)]></tr></table></td></tr></table><![endif]-->
    </div>
  </div>
...
var Ge = {
	web(t, e, r, { collection: n, variant: l }) {
		let { backgroundColor: o, backgroundImage: i, padding: a, columnsBackgroundColor: s, alignItems: d } = e, p = parseFloat(`${r.contentWidth || 0}`) == r.contentWidth ? `${parseFloat(`${r.contentWidth || 0}`)}px` : r.contentWidth, f = r.contentAlign === "left" ? "0 auto 0 0" : r.contentAlign === "right" ? "0 0 0 auto" : "0 auto", u = re(i, { displayMode: "web" }), m = ee(i, { displayMode: "web" }), g = "";
		o && (g += `background-color: ${o};`), a && (g += ` padding: ${a};`), i?.url && i?.fullWidth && (g += `background-image: url('${i.url}');`, g += `background-repeat: ${i?.repeat || "no-repeat"};`, u && (g += `background-position: ${u};`), m && (g += `background-size: ${m};`)), n === "footers" && (g += "margin-top: auto");
		let h = `max-width: ${p};margin: ${f};`;
		s && (h += `background-color: ${s};`), i?.url && !i?.fullWidth && (h += `background-image: url('${i.url}');`, h += `background-repeat: ${i?.repeat || "no-repeat"};`, u && (h += `background-position: ${u};`), m && (h += `background-size: ${m};`));
		let _ = "";
		d && (_ += ` align-items: ${d};`), g = g.trim(), h = h.trim(), _ = _.trim();
		let b = ne(e.anchor, l === "amp");
		return Jk({
			innerHTML: t,
			values: e,
			containerStyle: g,
	...
	email(t, e, r, n) {
		let { defaultDevice: l, variant: o, collection: i } = n, a = j(e.backgroundColor), s = j(e.columnsBackgroundColor), d = parseFloat(`${r.contentWidth || 0}`), p = d == r.contentWidth ? `${d}px` : r.contentWidth, f = r.contentAlign === "left" ? "0 auto 0 0" : r.contentAlign === "right" ? "0 0 0 auto" : "0 auto", { padding: u } = e, m = ne(e.anchor, o === "amp");
		return Kk({
			innerHTML: t,
			values: e,
			bgcolor: a,
			columnsBgcolor: s,
			contentWidthNumber: d,
			contentWidthWithUnit: p,
			hasBackgroundImageURL: !!e?.backgroundImage?.url,
			backgroundImage: e.backgroundImage,
			backgroundPosition: re(e.backgroundImage, { displayMode: "email" }),
			backgroundSize: ee(e.backgroundImage, { displayMode: "email" }),
			margin: f,
			padding: u,
			shouldHideByDefault: gt(e, {
				amp: o === "amp",
			...
			anchor: m,
			backgroundImageRepeat: typeof e?.backgroundImage?.repeat == "string" ? e?.backgroundImage?.repeat.includes("repeat") && e?.backgroundImage?.repeat !== "no-repeat" : e?.backgroundImage?.repeat,
			desktop: e?._override?.desktop || {},
			tablet: e?._override?.tablet || {},
			mobile: e?._override?.mobile || {},
			wrapperTag: Mc(i)
...
var Mc = (t) => t === "headers" ? "header" : t === "footers" ? "footer" : "div";
var Nc = {};
var uH = {
	href: {
		name: "web",
...
var pH = { html: "<strong>Hello, world!</strong>" };
var fH = {
	src: {
...
//#endregion
//#region ../node_modules/@unlayer/react-elements/dist/index.js
...
function fixedContentWidth(contentWidth) {
	if (typeof contentWidth === "number") return Number.isFinite(contentWidth) ? contentWidth : void 0;
...
function contentSlotWidth(ctx) {
	...
	const colWidth = (rowCells[columnIndex] || 1) / rowSpan * rowAvail;
...
function validateColumnLayout(layout, childrenCount) {
	if (layout.expectedColumns !== childrenCount) throw new Error(`${layout.name} layout expects ${layout.expectedColumns} <Column> components, but got ${childrenCount}. Layout: ${layout.description}. Make sure you have exactly ${layout.expectedColumns} <Column> children.`);
}
...
function textToTextJson(text) {
	...
	return `{"root":{"children":[{"children":[{"detail":0,"format":0,"mode":"normal","style":"","text":${JSON.stringify(text)},"type":"extended-text","version":1}],"format":"","indent":0,"type":"extended-paragraph","version":1,"textFormat":0,"textStyle":""}],"format":"","indent":0,"type":"root","version":1}}`;
}
var FORMAT_TAGS = [
	[
		1,
...
function textNodeToHtml(node) {
	...
	let openTags = "";
	let closeTags = "";
	for (const [bit, open, close] of FORMAT_TAGS) if (format & bit) {
		openTags += open;
...
function dirAttribute(direction) {
	return direction === "ltr" || direction === "rtl" ? ` dir="${direction}"` : "";
}
function paragraphAlign(format) {
	if (typeof format === "string") return [
		"left",
		"center",
		"right",
		"justify"
	].includes(format) ? format : void 0;
	if (typeof format === "number") return NUMERIC_ALIGN[format];
}
function paragraphNodeToHtml(node, childrenHtml) {
	const isInlineTool = !!node.isInlineTool;
	const tag = isInlineTool ? "span" : "p";
	const dir = dirAttribute(node.direction);
	const styleParts = [];
	if (node.style) styleParts.push(String(node.style).replace(/;+\s*$/, ""));
	if (!isInlineTool) styleParts.push("margin: 0px", "margin-block-start: 0px", "margin-block-end: 0px");
	const indent = Number(node.indent) || 0;
	if (indent > 0) styleParts.push(`padding-inline-start: ${indent * 40}px`);
	const align = paragraphAlign(node.format);
	if (align) styleParts.push(`text-align: ${align}`);
	return `<${tag}${dir}${styleParts.length > 0 ? ` style="${escapeHtml(styleParts.join("; ") + ";")}"` : ""}>${childrenHtml || "<br>"}</${tag}>`;
}
function nodeToHtml(node) {
	if (!node || typeof node !== "object") return "";
	const type = node.type;
	if (type === "text" || type === "extended-text") return textNodeToHtml(node);
	if (type === "linebreak") return "<br>";
	const childrenHtml = (node.children || []).map(nodeToHtml).join("");
	switch (type) {
		case "root": return childrenHtml;
		case "paragraph":
		case "extended-paragraph": return paragraphNodeToHtml(node, childrenHtml);
		case "heading": {
			const tag = /^h[1-6]$/.test(node.tag) ? node.tag : "h1";
			return `<${tag}${dirAttribute(node.direction)}>${childrenHtml}</${tag}>`;
		}
		case "link": return `<a${node.url ? ` href="${escapeHtml(node.url)}"` : ""}${node.target ? ` target="${escapeHtml(node.target)}"` : ""}${node.rel ? ` rel="${escapeHtml(node.rel)}"` : ""}>${childrenHtml}</a>`;
		case "list": {
...
function mergeValues(defaults, userValues) {
	...
	for (const key of Object.keys(userValues)) {
		...
		if (userVal !== null && defaultVal !== null && typeof userVal === "object" && typeof defaultVal === "object" && !Array.isArray(userVal) && !Array.isArray(defaultVal)) result[key] = mergeValues(defaultVal, userVal);
		else result[key] = userVal;
	}
	return result;
}
...
function analyzeNestedStructure(defaultValues) {
	...
	for (const [key, value] of Object.entries(defaultValues)) {
		if (key === "_meta" || key === "text" || key === "textJson" || key === "children") continue;
...
function normalizeCssProps(props) {
	...
	if (typeof props.fontWeight === "string" && /^\d+$/.test(props.fontWeight.trim())) props.fontWeight = Number(props.fontWeight.trim());
	if (typeof props.lineHeight === "number") props.lineHeight = String(props.lineHeight);
	for (const key of PX_SIZE_KEYS) {
		const v = props[key];
		if (typeof v === "number") props[key] = `${v}px`;
		else if (typeof v === "string" && /^\d+$/.test(v.trim())) props[key] = `${v.trim()}px`;
	}
}
function flattenChildrenText(node) {
	...
	if (typeof node === "object" && "props" in node) return flattenChildrenText(node.props?.children);
	return "";
}
function mapSemanticProps(props, defaultValues, componentType) {
	...
	if (children !== void 0 && !result.text && !result.textJson) {
		...
		if (componentType === "Paragraph") result.textJson = textToTextJson(textContent);
		else result.text = textContent;
	}
	...
	for (const [key, value] of Object.entries(userProps)) {
		...
		for (const [groupName, groupProps] of nestedGroups.entries()) if (groupProps.has(key)) {
			nested[groupName] = nested[groupName] || {};
			nested[groupName][key] = value;
			belongsToGroup = true;
			break;
		}
		if (!belongsToGroup) flat[key] = value;
	}
	const final = {
		...result,
		...flat
	};
	for (const [groupName, groupValues] of Object.entries(nested)) if (Object.keys(groupValues).length > 0) final[groupName] = {
		...result[groupName],
		...groupValues
	};
	if (defaultValues && typeof defaultValues === "object" && "border" in defaultValues) {
		...
		const collected = {};
		for (const key of Object.keys(final)) if (borderSideRe.test(key)) {
			collected[key] = final[key];
			delete final[key];
		}
		if (Object.keys(collected).length > 0) final.border = {
			...final.border || {},
			...collected
		};
		if (final.border && typeof final.border === "object") {
			const b = { ...final.border };
...
function normalizeLinkValue(value) {
	...
	if ("name" in v && (v.values && typeof v.values === "object" || v.attrs && typeof v.attrs === "object")) {
		...
		const { href: attrsHref, target: attrsTarget, ...customAttrs } = v.attrs && typeof v.attrs === "object" ? v.attrs : {};
		return {
...
function normalizeValuesForExporter(values, componentName) {
	...
	const out = { ...values };
	for (const key of ["href", "action"]) if (out[key] !== void 0) {
		const normalized = normalizeLinkValue(out[key]);
		if (normalized !== void 0) out[key] = normalized;
	}
	if (componentName === "Menu" && out.menu && Array.isArray(out.menu.items)) out.menu = {
		...out.menu,
...
function htmlToPlainText(html) {
	...
	text = text.replace(/<a[^>]+href=["']([^"']+)["'][^>]*>([\s\S]*?)<\/a>/gi, (_, href, content) => {
		...
		if (clean === href || clean === decodeEntities(href)) return clean;
		return `${clean} (${href})`;
	});
...
var ErrorFallback = ({ type, className, style }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	className,
	style,
	children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("strong", { children: [type, " failed to render."] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: "Check console for details." })
		]
	})
});
...
function renderComponent(config) {
	...
	try {
		...
		let html;
		if (innerHTML !== void 0) html = exporter(innerHTML, values, ...args);
		else {
			const meta = {
				exporterConfig,
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorFallback, {
			type,
			error,
			className,
			style
...
function createItemComponent(config) {
	function renderFn(props) {
		const { mode: modeProp, className, style, index = 0, _metaHtmlId, colIndex = 0, cells = [], bodyValues = {}, rowValues = {}, columnValues = {}, _config, children, ...restProps } = props;
		...
		const valuesForExporter = normalizeValuesForExporter(valuesWithMeta, config.name);
		const exportSrc = valuesForExporter.src;
		if (exportSrc && typeof exportSrc === "object" && exportSrc.autoWidth === false) valuesForExporter.src = pinImageSrc(exportSrc, contentSlotWidth({
...
var Button_default = createItemComponent({
	name: "Button",
	...
	propMapper: (props) => {
		...
		if (size && typeof size === "object" && !Array.isArray(size)) {
			const s = size;
			if (typeof s.width === "number") s.width = `${s.width}px`;
			else if (typeof s.width === "string" && /^\d+(?:\.\d+)?$/.test(s.width.trim())) s.width = `${s.width.trim()}px`;
			if (s.width !== void 0 && s.autoWidth === void 0) s.autoWidth = false;
		}
		return mapped;
	},
	displayName: "Button",
...
var DEFAULT_VALUES2 = { ...cH };
var Divider_default = createItemComponent({
	name: "Divider",
...
var Heading_default = createItemComponent({
	name: "Heading",
	defaultValues: DEFAULT_VALUES3,
	propMapper: (props) => {
		const { level, ...rest } = props;
		const result = mapSemanticProps(rest, DEFAULT_VALUES3, "Heading");
		if (level && !result.headingType) result.headingType = level;
		return result;
	},
	displayName: "Heading",
	exporters: Qt
});
var DEFAULT_VALUES4 = { ...pH };
var Html_default = createItemComponent({
	name: "Html",
...
var { height: _placeholderHeight, ...defaultSrc } = fH.src;
var DEFAULT_VALUES5 = {
	...fH,
	src: {
		...defaultSrc,
...
var Image_default = createItemComponent({
	name: "Image",
	defaultValues: DEFAULT_VALUES5,
	propMapper: (props) => {
		const { alt, src, width: widthProp, maxWidth: maxWidthProp, ...rest } = props;
		const restValues = rest.values;
		const base = mapSemanticProps(restValues && typeof restValues.src === "string" ? {
			...rest,
			values: {
				...restValues,
				src: { url: restValues.src }
			}
		} : rest, DEFAULT_VALUES5, "Image");
		if (alt !== void 0) base.altText = alt;
		...
		if (src !== void 0 || baseSrc !== void 0) {
			const merged = {
				...typeof src === "string" || src === void 0 && typeof baseSrc === "string" ? {
					autoWidth: true,
					maxWidth: "100%"
				} : { ...DEFAULT_VALUES5.src },
				...userSrc
			...
			if (userSrc.autoWidth === void 0) if (displayPct && displayPct !== "100%") {
...
mH.menu;
var DEFAULT_VALUES6 = { ...mH };
var Menu_default = createItemComponent({
	name: "Menu",
	...
	propMapper: (props) => {
		...
		if (Array.isArray(items)) {
			...
			const base = mapSemanticProps(rest, DEFAULT_VALUES6, "Menu");
			base.menu = { items: mapped };
			return base;
		}
		return mapSemanticProps(props, DEFAULT_VALUES6, "Menu");
	},
	displayName: "Menu",
	exporters: Cs
});
...
var Paragraph_default = createItemComponent({
	name: "Paragraph",
...
var DEFAULT_ICONS = hH.icons ?? {
	iconType: "circle",
	icons: []
};
var DEFAULT_VALUES8 = { ...hH };
var Social_default = createItemComponent({
	name: "Social",
	...
	propMapper: (props) => {
		...
		if (Array.isArray(icons)) {
			...
			const base = mapSemanticProps(rest, DEFAULT_VALUES8, "Social");
			base.icons = {
		...
		return coerceSizes(mapSemanticProps(props, DEFAULT_VALUES8, "Social"));
	},
	displayName: "Social",
	exporters: dt
});
...
var Table_default = createItemComponent({
	name: "Table",
	...
	propMapper: (props) => {
		...
		if (headers || data || typeof columns === "number" || typeof rows === "number") {
			const base = mapSemanticProps(rest, DEFAULT_VALUES9, "Table");
			const colCount = headers ? headers.length : typeof columns === "number" ? columns : data?.[0]?.length ?? 0;
			const blankCells = (n) => Array.from({ length: n }, () => ({
				text: "",
				width: 0
			}));
			base.table = {
				...
				rows: data ? data.map((row) => ({
					...
					height: 0
				})) : typeof rows === "number" ? Array.from({ length: rows }, () => ({
					cells: blankCells(colCount),
					height: 0
				})) : [],
				footers: []
			};
			if (headers || typeof columns === "number") base.columns = colCount;
			if (headers) base.enableHeader = true;
			if (data) base.rows = data.length;
			else if (typeof rows === "number") base.rows = rows;
			return base;
		}
		return mapSemanticProps(props, DEFAULT_VALUES9, "Table");
	},
	displayName: "Table",
	exporters: ir
});
...
var Video_default = createItemComponent({
	name: "Video",
	...
	propMapper: (props) => {
		...
		if (typeof videoUrl === "string") {
			...
			const base = mapSemanticProps(rest, DEFAULT_VALUES10, "Video");
			if (parsed) base.video = {
				...DEFAULT_VIDEO,
				...parsed
			};
			return base;
		}
		return mapSemanticProps(props, DEFAULT_VALUES10, "Video");
	},
	displayName: "Video",
	exporters: ur
});
var { popupPosition: _p1, popupDisplayDelay: _p2, popupWidth: _p3, popupHeight: _p4, popupBackgroundColor: _p5, popupBackgroundImage: _p6, popupOverlay_backgroundColor: _p7, popupCloseButton_position: _p8, popupCloseButton_backgroundColor: _p9, popupCloseButton_iconColor: _p10, popupCloseButton_borderRadius: _p11, popupCloseButton_margin: _p12, popupCloseButton_action: _p13, ...bodyRest } = CH;
var BODY_DEFAULTS = bodyRest;
var ROW_DEFAULTS = { ...vH };
var COLUMN_DEFAULTS = { ...wH };
...
function generateGridCSS(cells, mode, contentWidth = 600, mobileBreakpoint = 480) {
...
.u-row .u-col {
  ...
  padding-left: 0;
	...
	const columnCSS = widths.map(({ value, className }) => `.u-row .u-col.u-col-${className} { flex: 0 0 ${value}%; max-width: ${value}%; }`).join("\n");
...
function renderRowToHtml(innerHTML, values, bodyValues, mode, cells, collection = "rows") {
	const html = (Ge[mode] || Ge.web)(innerHTML, values, bodyValues, {
		collection,
		variant: mode
	});
	const css = generateGridCSS(cells, mode, toContentWidthPx(bodyValues));
...
function processChildren(children, cells, bodyValues, rowValues, mode, _config) {
	...
	import_react.Children.toArray(children).forEach((child, index) => {
		if (!import_react.isValidElement(child)) {
			if (typeof child === "string" || typeof child === "number") innerHTML += String(child);
			return;
		}
		const componentType = child.type;
		if ((componentType?.displayName === "Column" || componentType?.name === "Column") && typeof child.type === "function") {
			...
			if (rendered?.props?.dangerouslySetInnerHTML?.__html) innerHTML += rendered.props.dangerouslySetInnerHTML.__html;
		} else if (import_react.isValidElement(child)) {
			const name = child.type?.displayName || child.type?.name || "Unknown";
			console.warn(`Row: <${name}> is not a valid Row child. Only <Column> components can be direct children of <Row>. Wrap it in a <Column>: <Row><Column><${name} /></Column></Row>`);
		}
	});
	return innerHTML;
}
var Row = (props) => {
	const { layout, cells: propsCells, children, mode: modeProp, className, style, index = 0, bodyValues = {}, collection = "rows", _config, ...semanticProps } = props;
	const mode = modeProp ?? _config?.mode ?? "web";
	let cells;
	if (layout) {
		validateColumnLayout(layout, import_react.Children.count(children));
		cells = layout.cells;
	} else if (propsCells) cells = propsCells;
	else {
		const columnCount = import_react.Children.toArray(children).filter((c) => import_react.isValidElement(c) && /^Column$/.test(c.type?.displayName || c.type?.name || "")).length;
	...
	const values = mapSemanticProps(semanticProps, DEFAULT_VALUES11, "Row");
	const valuesWithMeta = {
		...values,
		cells,
		_meta: {
	...
	const innerHTML = processChildren(children, cells, safeBodyValues, valuesWithMeta, mode, _config);
	try {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			dangerouslySetInnerHTML: { __html: renderRowToHtml(innerHTML, valuesWithMeta, safeBodyValues, mode, cells, collection) },
			className,
			style
		});
	} catch (error) {
...
function renderColumnToHtml(innerHTML, values, index, cells, bodyValues, rowValues, mode) {
	return (Ne[mode] || Ne.web)(innerHTML, values, index, cells, bodyValues, rowValues);
}
function renderContentToHtml(innerHTML, values, bodyValues, mode) {
	return (Vc[mode] || Vc.web)(innerHTML, values, bodyValues, {});
}
var Column = (props) => {
	const { children, index = 0, cells = [1], bodyValues = {}, rowValues = {}, mode: modeProp, className, style, _config, ...semanticProps } = props;
	const mode = modeProp ?? _config?.mode ?? "web";
	const values = mapSemanticProps(semanticProps, DEFAULT_VALUES12, "Column");
	const valuesWithMeta = {
		...values,
		_meta: {
	...
	let innerHTML = "";
	if (children) try {
		import_react.Children.toArray(children).forEach((child, childIndex) => {
			if (typeof child === "string" || typeof child === "number") innerHTML += String(child);
			else if (import_react.isValidElement(child)) {
				if (typeof child.type === "function") {
					const ComponentType = child.type;
					const renderFn = ComponentType[UNLAYER_RENDER_KEY] || ComponentType;
					const componentName = ComponentType?.[UNLAYER_CONFIG_KEY]?.metaName ?? (ComponentType?.displayName || ComponentType?.name || "component").toLowerCase();
					...
					if (rendered && typeof rendered === "object" && rendered.props && rendered.props.dangerouslySetInnerHTML) {
						...
						const contentValues = {
							containerPadding: typeof rawContainerPadding === "number" ? `${rawContainerPadding}px` : rawContainerPadding,
							_meta: {
								htmlID: contentHtmlId,
								htmlClassNames: `u_content_${componentName}`
							}
						};
						innerHTML += renderContentToHtml(componentHTML, contentValues, bodyValues, mode);
					} else if (rendered) {
						const name = child.type?.displayName || child.type?.name || "Unknown";
						console.warn(`Column: <${name}> did not produce renderable HTML. Ensure it is an Unlayer component (Button, Text, Image, etc.).`);
					}
				}
			}
		});
	...
	try {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			dangerouslySetInnerHTML: { __html: renderColumnToHtml(innerHTML, valuesWithMeta, index, cells, bodyValues, rowValues, mode) },
			className,
			style
		});
	} catch (error) {
...
function generatePreviewHtml(text) {
	...
	let padding = "";
	for (let i = 0; i < paddingLength; i++) padding += PADDING_CHARS[i % PADDING_CHARS.length];
...
function renderBodyToHtml(innerHTML, values, mode, previewText) {
	...
	if (mode === "email" && previewText) {
		...
		if (previewHtml) finalInnerHtml = previewHtml + innerHTML;
	}
	const bodyExporter = Ls[mode] || Ls.web;
	return (mode === "document" ? bodyExporter(finalInnerHtml, values, { type: "" }) : mode === "email" ? bodyExporter(finalInnerHtml, values, { bodyValues: values }) : bodyExporter(finalInnerHtml, values, values)).replace("min-height: 100vh; ", "").replace("min-height: 100vh;", "");
}
var Body = (props) => {
	...
	_config.__ids = {};
	const values = mergeValues(DEFAULT_VALUES13, mapSemanticProps(semanticProps, DEFAULT_VALUES13, "Body"));
	const valuesWithMeta = {
		...values,
		_meta: {
	...
	if (children) enrichedChildren = import_react.Children.map(children, (child) => {
	...
	let innerHTML = "";
	if (enrichedChildren) try {
		innerHTML = import_server_browser.renderToString(enrichedChildren);
	} catch (error) {
	...
	try {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			dangerouslySetInnerHTML: { __html: renderBodyToHtml(innerHTML, valuesWithMeta, mode, previewText) },
			className,
			style
		});
	} catch (error) {
...
function Email(props) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body_default, {
		...props,
		mode: "email"
	});
}
...
function getUnlayerContext() {
	if (!_UnlayerContext) _UnlayerContext = (0, import_react.createContext)(DEFAULT_CONFIG);
	return _UnlayerContext;
}
var UnlayerProvider = ({ config, children }) => {
	const merged = (0, import_react.useMemo)(() => ({
		...DEFAULT_CONFIG,
		...config,
		[PROVIDER_ACTIVE_KEY]: true
	}), [config]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(getUnlayerContext().Provider, {
		value: merged,
		children
	});
};
...
function useUnlayerConfig() {
	return (0, import_react.useContext)(getUnlayerContext());
}
...
function collectChildren(node) {
	...
	import_react.Children.forEach(node, (child) => {
		if (import_react.isValidElement(child)) result.push(child);
	});
	return result;
}
function extractSemanticProps(props, extraKeys = []) {
	...
	const result = {};
	for (const [key, value] of Object.entries(props)) if (!internalKeys.has(key) && value !== void 0) result[key] = value;
	return result;
}
...
function walkItem(element, bodyValues, displayMode, headConfig, counters, styles, scripts, tags) {
	const config = element.type[UNLAYER_CONFIG_KEY];
	if (!config) return;
	const { name, defaultValues, propMapper } = config;
	const { children, ...restProps } = element.props;
	const finalValues = mergeValues(defaultValues, propMapper({
		children,
		...restProps
	}));
	const contentType = config.metaName ?? name.toLowerCase();
	const valuesWithMeta = ensureMeta(finalValues, contentType, nextCounter(counters, `u_content_${contentType}`) - 1);
	callHead(config.head ?? SH[name], valuesWithMeta, bodyValues, displayMode, headConfig, styles, scripts, tags);
}
function walkColumn(element, bodyValues, rowValues, displayMode, headConfig, counters, styles, scripts, tags) {
	const mapped = mapSemanticProps(extractSemanticProps(element.props), COLUMN_DEFAULTS, "Column");
	const count = nextCounter(counters, "u_column");
	const columnValues = ensureMeta(mergeValues(COLUMN_DEFAULTS, mapped), "column", count - 1);
	const columnHead = SH["Column"];
	...
	for (const child of children) walkItem(child, bodyValues, displayMode, headConfig, counters, styles, scripts, tags);
}
function walkRow(element, bodyValues, displayMode, headConfig, counters, styles, scripts, tags) {
	const mapped = mapSemanticProps(extractSemanticProps(element.props, ["layout"]), ROW_DEFAULTS, "Row");
	const count = nextCounter(counters, "u_row");
	const rowValues = ensureMeta(mergeValues(ROW_DEFAULTS, mapped), "row", count - 1);
	const rowHead = SH["Row"];
	callHead(rowHead, rowValues, bodyValues, displayMode, headConfig, styles, scripts, tags);
	const children = collectChildren(element.props.children);
	for (const child of children) if (getDisplayName(child) === "Column") walkColumn(child, bodyValues, rowValues, displayMode, headConfig, counters, styles, scripts, tags);
}
function extractHeadFromTree(element, options) {
	...
	const tags = [];
	const counters = {};
	const bodyValues = ensureMeta(mergeValues(BODY_DEFAULTS, mapSemanticProps(extractSemanticProps(element.props), BODY_DEFAULTS, "Body")), "body", 0);
	const bodyHead = SH["Body"];
	callHead(bodyHead, bodyValues, bodyValues, displayMode, headConfig, styles, scripts, tags);
	const children = collectChildren(element.props.children);
	for (const child of children) if (getDisplayName(child) === "Row") walkRow(child, bodyValues, displayMode, headConfig, counters, styles, scripts, tags);
...
function resolveDisplayMode(element, mergedConfig) {
	const displayName = element.type?.displayName;
	return (displayName ? MODE_BY_WRAPPER[displayName] : void 0) ?? element.props.mode ?? mergedConfig.mode ?? "web";
}
function renderBody(element, config) {
	const mergedConfig = {
		...DEFAULT_CONFIG,
		...config
	};
	try {
		return (0, import_server_browser.renderToStaticMarkup)(import_react.cloneElement(element, { config: mergedConfig }));
	} catch (error) {
		const message = error instanceof Error ? error.message : String(error);
		throw new Error(`[Unlayer] renderToHtml failed: ${message}
...
function renderToHtml(element, options) {
	...
	const wrapperName = element.type?.displayName;
	const isUnlayerWrapper = wrapperName === "Body" || (wrapperName ? wrapperName in MODE_BY_WRAPPER : false);
	...
	const layoutArgs = {
		dir: mergedConfig.textDirection ? ` dir="${escapeForHtml(String(mergedConfig.textDirection))}"` : "",
		titleTag: title ? `<title>${escapeForHtml(title.trim())}</title>` : "",
		styleTag: css ? `<style type="text/css">
${css}
</style>` : "",
		scriptTag: js ? `<script type="application/javascript">
${js}
<\/script>` : "",
		tagLines: tags.join("\n"),
		fontLinks: fonts.filter((font) => font?.url).map((font) => `<link href="${escapeForHtml(font.url)}" rel="stylesheet" type="text/css">`).join(""),
		body
	};
...
function renderToPlainText(element, config) {
	return htmlToPlainText(renderBody(element, config));
}
function renderToHtmlParts(element, config) {
	...
	const { css, js, tags } = extractHeadFromTree(element, {
		displayMode: resolveDisplayMode(element, mergedConfig),
		headConfig: mergedConfig.headConfig
	});
	const headParts = [];
	if (css) headParts.push(`<style>${css}</style>`);
	if (js) headParts.push(`<script>${js}<\/script>`);
	if (tags.length > 0) headParts.push(...tags);
	return {
		head: headParts.join("\n"),
		body,
		css,
...
var schemaVersion = 24;
function getDisplayName2(element) {
	const type = element.type;
	return type?.displayName || type?.name;
}
var VALID_ROOTS = /* @__PURE__ */ new Set([
	"Body",
	"Email",
	"Page",
	"Document"
...
function unwrapRoot(element) {
	...
	for (let depth = 0; depth < 10; depth++) {
		...
		if (!(typeof type === "function" && !type.prototype?.isReactComponent)) break;
		let produced;
		try {
			produced = type({ ...current.props });
		} catch (cause) {
			const detail = cause instanceof Error ? cause.message : String(cause);
			throw new Error(`[Unlayer] renderToJson: could not unwrap <${name || "wrapper"}>. A wrapper must be a plain component that synchronously returns a root (<Email>, <Page>, <Document>, or <Body>) and uses no React hooks. Pass the root element directly \u2014 e.g. renderToJson(<Email>\u2026</Email>). (${detail})`);
		}
		if (!import_react.isValidElement(produced)) break;
		current = produced;
	}
	return current;
}
...
function extractTextFromTextJson(textJson) {
	try {
		...
		for (const paragraph of root.children) {
			...
			const parts = [];
			for (const node of paragraph.children) if (node?.text) parts.push(node.text);
...
function processItem(element, counters, layout = {}) {
	...
	if (!config) {
		...
		throw new Error(`[Unlayer] renderToJson: <${name2}> is not a recognized Unlayer item component. Only components created with createItemComponent are supported.`);
	}
	...
	const id = makeId(metaBase, nextCounter2(counters, metaBase));
	const { children, ...restProps } = element.props;
	const finalValues = mergeValues(defaultValues, propMapper({
		children,
		...restProps
	...
	if (itemSrc && typeof itemSrc === "object" && itemSrc.autoWidth === false) values.src = pinImageSrc(itemSrc, contentSlotWidth({
		...layout,
...
function processColumn(element, counters, layout = {}) {
	const id = makeId("u_column", nextCounter2(counters, "u_column"));
	const values = mergeValues(COLUMN_DEFAULTS, mapSemanticProps(extractSemanticProps2(element.props), COLUMN_DEFAULTS, "Column"));
	const valuesWithMeta = {
		...values,
		_meta: {
			htmlID: id,
	...
	for (const child of children) contents.push(processItem(child, counters, itemLayout));
	return {
		contents,
...
function processRow(element, counters, parentLayout = {}) {
	const id = makeId("u_row", nextCounter2(counters, "u_row"));
	const { layout, cells: propsCells } = element.props;
	let cells;
	if (layout) cells = layout.cells;
	else if (propsCells) cells = propsCells;
	else {
		const columnCount = Math.max(1, collectChildren2(element.props.children).filter((child) => getDisplayName2(child) === "Column").length);
		cells = Array(columnCount).fill(1);
	}
	const values = mergeValues(ROW_DEFAULTS, mapSemanticProps(extractSemanticProps2(element.props, ["layout"]), ROW_DEFAULTS, "Row"));
	const valuesWithMeta = {
		...values,
	...
	for (const child of children) {
		...
		if (name === "Column") {
			...
			columnIndex += 1;
		} else console.warn(`[Unlayer] renderToJson: <${name}> is not a valid Row child. Only <Column> is allowed.`);
	}
	return {
		cells,
		columns,
...
function processBody(element, counters) {
	const id = "u_body";
	const values = mergeValues(BODY_DEFAULTS, mapSemanticProps(extractSemanticProps2(element.props), BODY_DEFAULTS, "Body"));
	const previewText = element.props.previewText;
	if (previewText !== void 0) values.preheaderText = previewText;
	const valuesWithMeta = {
		...values,
		_meta: {
			htmlID: id,
	...
	for (const child of children) {
		const name = getDisplayName2(child);
		if (name === "Row") rows.push(processRow(child, counters, { bodyValues: valuesWithMeta }));
		else console.warn(`[Unlayer] renderToJson: <${name}> is not a valid Body child. Only <Row> is allowed.`);
	}
	return {
		rows,
		values: valuesWithMeta
...
function renderRowToJson(element) {
	...
	if (displayName !== "Row") throw new Error(`[Unlayer] renderRowToJson: Element must be <Row>, but got <${displayName || "unknown"}>. For full designs, use renderToJson instead.`);
	return processRow(element, {});
}
function renderToJson(element) {
	element = unwrapRoot(element);
	const displayName = getDisplayName2(element);
	if (!displayName || !VALID_ROOTS.has(displayName)) throw new Error(`[Unlayer] renderToJson: Root element must be <Body>, <Email>, <Page>, or <Document>, but got <${displayName || "unknown"}>. Wrap your content: <Body><Row><Column>...</Column></Row></Body>`);
	const counters = {};
	return {
		counters,
		body: processBody(element, counters),
		schemaVersion
	};
}
function initialValuesFromOptions(options) {
	const result = {};
	for (const group of Object.values(options ?? {})) for (const [property, option] of Object.entries(group?.options ?? {})) {
		if (!option || option.enabled === false) continue;
		if (typeof option.defaultValue !== "undefined") result[property] = option.defaultValue;
	}
	return result;
}
function withSanitizer(exporter) {
	return (values, ...args) => {
		const html = String(exporter(values, ...args) ?? "");
		const toSafeHtml = args[args.length - 1]?.exporterConfig?.toSafeHtml;
		return typeof toSafeHtml === "function" ? toSafeHtml(html) : html;
	};
}
function withLinkNormalization(exporter, linkKeys) {
...
function linkWidgetKeys(options) {
	const keys = [];
	for (const group of Object.values(options ?? {})) for (const [key, option] of Object.entries(group?.options ?? {})) if (option && option.widget === "link") keys.push(key);
	return keys;
}
function registerTool(tool) {
	if (!tool?.name || typeof tool.name !== "string") throw new Error("[Unlayer] registerTool: `name` is required");
	const exporters = tool.renderer?.exporters;
	if (!exporters || !exporters.web && !exporters.email) throw new Error(`[Unlayer] registerTool("${tool.name}"): \`renderer.exporters\` needs at least a \`web\` or \`email\` exporter`);
	...
	for (const mode of [
		...
		if (exporter) sanitized[mode] = withSanitizer(withLinkNormalization(exporter, linkKeys));
	}
